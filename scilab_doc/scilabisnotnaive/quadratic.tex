...
The naive, simplified, algorithm to use to compute the roots of the 
...
The result is astonishing, since the naive root has 
...
point numbers. The solution is $\epsilon=10^{-155}$.
