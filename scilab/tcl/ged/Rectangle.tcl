...
Notebook:create $uf.n -pages {Style Data Clipping} -pad 0  -height 350 -width 320
...
label $w.frame.colorlabel -height 0 -text "         Color: " -width 0  -font {Arial 9}
#         -foreground $color
...
label $w.frame.filledlabel -height 0 -text "         Filled: " -width 0  -font {Arial 9}
...
pack $w.frame.filled  -in $w.frame.fil   -side left -fill x -pady 0m -padx 2m
...
pack $w.frame.markmode   -in $w.frame.rectmarkmode  -side left  -fill x -pady 0m -padx 2m
...
label $w.frame.labelul -text "  Upper-left point coordinates " -font {Arial 9}
...
label $w.frame.labelwh -text "  Width and height  " -font {Arial 9}
...
label $w.frame.labelw -text "     W:" -font {Arial 9}
entry $w.frame.dataw -relief sunken  -textvariable Wval  -width 10 -font {Arial 9}
label $w.frame.labelh -text "     H: " -font {Arial 9}
...
#exit button
frame $w9.buttons
button $w9.b -text Quit -command "destroy $ww" -font {Arial 9}
