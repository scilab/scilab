...
label $w.frame.scalesw.label -height 0 -text "Color flag:" -width 0  -font {Arial 9} -anchor e -width $largeur
...
pack $w.scicomX.text1  -side left  -fill both -padx 2m
...
pack $w.scicomY.text1  -side left  -fill both -padx 2m
...
pack $w.scicomZ.text1  -side left  -fill both -padx 2m
...
pack $w.scicomCOLOR.text1  -side left  -fill both -padx 2m
