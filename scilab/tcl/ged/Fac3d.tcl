...
if {$flagCOLOR == 1} {
Notebook:create $uf.n -pages {"Style" "X matrix" "Y matrix" "Z matrix" "Color data"} -pad 20 -height 540 -width 600
} else {
Notebook:create $uf.n -pages {"Style" "X matrix" "Y matrix" "Z matrix" } -pad 20 -height 540 -width 600
}
