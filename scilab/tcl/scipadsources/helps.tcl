...
proc aboutme {} {
	...
	tk_messageBox -title "About" -type ok \
	    -message "$winTitle $version\n\
            ...
            Miscellaneous improvements, particularly debug tools, by
François Vogel 2004-2005."
    } else {
	tk_messageBox -title "A propos" -type ok \
	    -message "$winTitle $version\n\
            Créé par Joseph Acosta, joeja@mindspring.com.\n\
            Modifié par le Consortium Scilab.\n\
            Amélioré par Enrico Segre 2003-2005.\n\
            Améliorations diverses, dont outils de débug, par François
Vogel 2004-2005."
    }
}
