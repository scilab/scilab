...
nm = nmplot_configure(nm,"-simplexfn","simplex.txt");
nm = nmplot_configure(nm,"-fbarfn","fbar.txt");
nm = nmplot_configure(nm,"-foptfn","fopt.txt");
nm = nmplot_configure(nm,"-sigmafn","sigma.txt");
sfn = nmplot_cget ( nm , "-simplexfn" );
assert_checkequal ( sfn , "simplex.txt" );
sfn = nmplot_cget ( nm , "-fbarfn" );
assert_checkequal ( sfn , "fbar.txt" );
sfn = nmplot_cget ( nm , "-foptfn" );
assert_checkequal ( sfn , "fopt.txt" );
sfn = nmplot_cget ( nm , "-sigmafn" );
assert_checkequal ( sfn , "sigma.txt" );
// Check the display
disp(nm);
