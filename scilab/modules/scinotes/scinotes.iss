...
;
Source: modules\{#SCINOTES}\VERSION.xml; DestDir: {app}\modules\{#SCINOTES}; Components: {#COMPN_SCINOTES}
Source: modules\{#SCINOTES}\readme.txt; DestDir: {app}\modules\{#SCINOTES}; Components: {#COMPN_SCINOTES}
Source: modules\{#SCINOTES}\license.txt; DestDir: {app}\modules\{#SCINOTES}; Components: {#COMPN_SCINOTES}
Source: modules\{#SCINOTES}\changelog.txt; DestDir: {app}\modules\{#SCINOTES}; Components: {#COMPN_SCINOTES}
;
