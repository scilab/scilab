...
assert_checkerror("h5dataset(""42"",42,42,42,42)",msgerr,999);
msgerr = msprintf(gettext("%s: Bad dimensions for input argument #3: five rows expected."), "h5dataset");
assert_checkerror("h5dataset(""42"",""42"",42,42,42)",msgerr,999);
...
msgerr = msprintf(gettext("%s: Bad dimensions for input argument #5: six rows expected."), "h5dataset");
assert_checkerror("h5dataset(""42"",""42"",[42;42;42;42;42],42,42)",msgerr,999);
