...
/**
 * Set the font weight of a uicontrol
 *
 ...
 */
GUI_IMPEXP int SetUicontrolFontWeight(void* _pvCtx, char *pobjUID, size_t stackPointer, int valueType, int nbRow, int nbCol);
