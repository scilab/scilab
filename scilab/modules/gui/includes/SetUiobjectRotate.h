...
#ifndef __SET_UIOBJECT_ROTATE_H__
#define __SET_UIOBJECT_ROTATE_H__
#include "dynlib_gui.h"
#include "ObjectStructure.h"

/**
 * Set the rotate property of a uicontrol imagerender
 *
 ...
 */
GUI_IMPEXP int SetUiobjectRotate(sciPointObj * pobj, size_t stackPointer, int valueType, int nbRow, int nbCol);

#endif /* __SET_UIOBJECT_ROTATE_H__ */
