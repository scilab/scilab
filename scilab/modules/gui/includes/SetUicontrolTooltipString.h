...
#ifndef __SET_UICONTROL_TOOLTIPSTRING_H__
#define __SET_UICONTROL_TOOLTIPSTRING_H__
 ...
 */
GUI_IMPEXP int SetUicontrolTooltipString(void* _pvCtx, char * pobjUID, size_t stackPointer, int valueType, int nbRow, int nbCol ) ;

#endif /* __SET_UICONTROL_TOOLTIPSTRING_H__ */
