...
#ifndef __SET_UIOBJECT_SHEAR_H__
#define __SET_UIOBJECT_SHEAR_H__
#include "dynlib_gui.h"
#include "ObjectStructure.h"

/**
 * Set the shear property of a uicontrol imagerender
 *
 ...
 */
GUI_IMPEXP int SetUiobjectShear(sciPointObj * pobj, size_t stackPointer, int valueType, int nbRow, int nbCol);

#endif /* __SET_UIOBJECT_SHEAR_H__ */
