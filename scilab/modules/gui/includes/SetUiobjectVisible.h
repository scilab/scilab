...
#ifndef __SETUIOBJECTVISIBLE_H__
#define __SETUIOBJECTVISIBLE_H__
#include "dynlib_gui.h"
#include "ObjectStructure.h"
#include "returnProperty.h"

/**
 * Set the visibility status of a uicontrol or uimenu
 *
 ...
 */
GUI_IMPEXP int SetUiobjectVisible(sciPointObj * pobj, size_t stackPointer, int valueType, int nbRow, int nbCol ) ;
