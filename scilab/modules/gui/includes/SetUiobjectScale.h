...
#ifndef __SET_UIOBJECT_SCALE_H__
#define __SET_UIOBJECT_SCALE_H__
#include "dynlib_gui.h"
#include "ObjectStructure.h"

/**
 * Set the scale property of a uicontrol imagerender
 *
 ...
 */
GUI_IMPEXP int SetUiobjectScale(sciPointObj * pobj, size_t stackPointer, int valueType, int nbRow, int nbCol);

#endif /* __SET_UIOBJECT_SCALE_H__ */
