...
*/
public class DataProperties extends Legend implements SimpleSection {
    ...
    */
    ...
    public final void initComponents() {
        ...
        cClipState.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                GraphicController.getController().setProperty(
                        currentLegend, GraphicObjectProperties.__GO_CLIP_STATE__,
        ...
        layout.addLabelComboBox(pDataProperties, lText, MessagesGED.text,
    ...
    public final void loadProperties(String objectID) {
        if (objectID != null) {
            ...
            cClipState.setSelectedIndex((Integer) GraphicController.getController()
                                .getProperty(currentLegend, GraphicObjectProperties.__GO_CLIP_STATE__));
            ...
            cUserData.setText((String) GraphicController.getController()
                                .getProperty(currentLegend, GraphicObjectProperties.__GO_USER_DATA__));
        }
    }
    ...
    */
    private void getClipBox() {
        Double[] currentClipBox = (Double []) GraphicController.getController()
                    .getProperty(currentLegend, GraphicObjectProperties.__GO_CLIP_BOX__);
    ...
    */
    private void updateClipBox() {
        try {
            ...
            GraphicController.getController()
                       .setProperty(currentLegend, GraphicObjectProperties.__GO_CLIP_BOX__, value);
            titleClipBox();
    ...
    */
    private void updateTag() {
        GraphicController.getController().setProperty(
                currentLegend, GraphicObjectProperties.__GO_TAG__, cTag.getText());
    }
    ...
    */
    private void updateUserData() {
        GraphicController.getController().setProperty(
                currentLegend, GraphicObjectProperties.__GO_USER_DATA__, cUserData.getText());
    }
