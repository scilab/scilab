...
int SetUiobjectShear(char *sciObjUID, size_t stackPointer, int valueType, int nbRow, int nbCol)
{
    BOOL status = FALSE;
    ...
    status = setGraphicObjectProperty(sciObjUID, const_cast<char*>(__GO_UI_SHEAR__), getDoubleMatrixFromStack(stackPointer), jni_double_vector, 2);
