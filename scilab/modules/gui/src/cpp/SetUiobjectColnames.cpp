 ...
 * Sets the column names of a uicontrol uitable. 
 * 
...
int SetUiobjectColnames(sciPointObj* sciObj, size_t stackPointer, int valueType, int nbRow, int nbCol)
{
      ...
      switch(pUICONTROL_FEATURE(sciObj)->style)
        ...
        case SCI_UITABLE:
          ...
          if (nbCol > 1 && nbRow > 1) {
            ...
            CallScilabBridge::setUiTableColnames(getScilabJavaVM(), 
