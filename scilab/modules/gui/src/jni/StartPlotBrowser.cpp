...
giws --disable-return-size-array --output-dir src/jni/ --throws-exception-on-error --description-file src/jni/StartPlotBrowser.giws.xml
*/
/*
...
static jmethodID voidplotBrowserjintintID = curEnv->GetStaticMethodID(cls, "plotBrowser", "(I)V" ) ;
