...
set(h, "string", "Default slider");

// Creation without parent
h = uicontrol("style", "slider");
set(h, "string", "Black slider");
...
h = uicontrol("parent", gcf(), "style", "slider");
set(h, "string", "White slider");
...
h = uicontrol("style", "slider", "parent", gcf());
set(h, "string", "Light grey slider");
...
h = uicontrol("parent", gcf(), "style", "slider", "position", [0 0 200 20], "string", "I''m a bottom left slider");
set(h, "backgroundcolor", [1 0 0]);
set(h, "foregroundcolor", [0 0 1]);

h = uicontrol("parent", gcf(), "style", "slider", "position", [figsize(1)-200 0 200 20], "string", "I''m a bottom right slider");
set(h, "backgroundcolor", [0 1 0]);
set(h, "foregroundcolor", [1 0 0]);

h = uicontrol("parent", gcf(), "style", "slider", "position", [0 figsize(2)-20 200 20], "string", "I''m a top left slider");
set(h, "backgroundcolor", [0 0 1]);
set(h, "foregroundcolor", [1 0.5 0]);

h = uicontrol("parent", gcf(), "style", "slider", "position", [figsize(1)-200 figsize(2)-20 200 20], "string", "I''m a top right slider", "fontweight", "bold");
