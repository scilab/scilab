...
ierr = execstr("uicontrol(1,""style"",""text"",""string"",""Solution"",""position"",[603,30,192,120],""horizontalalignment"",""center"")", "errcacth");
msg = lasterror();
...
msg = lasterror();
if ierr==0 | msg<>msprintf(gettext("%s: Wrong type for ''%s'' property: A ''%s'' or a ''%s'' handle expected.\n"),"set_parent_property","Parent","Figure", "Frame uicontrol") then
  pause
end
