...
std::unordered_map<std::string, std::string> DeprecatedChecker::initDep()
{
    ...
    map.emplace("xclear", "clf");
    map.emplace("xpause", "sleep");
    map.emplace("havewindow", "getscilabmode");
    ...
    map.emplace("strcmpi", "strcmp");
    map.emplace("jconvMatrixMethod", "jautoTranspose");
    return map;
}
