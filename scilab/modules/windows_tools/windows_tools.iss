...
Source: modules\{#WINDOWS_TOOLS}\help\removechapter.sce; DestDir: {app}\modules\{#WINDOWS_TOOLS}\help; Flags: recursesubdirs; Components: {#COMPN_SCILAB}
;
...
;
Source: modules\{#WINDOWS_TOOLS}\languages\*.xml; DestDir: {app}\modules\{#WINDOWS_TOOLS}\languages; Flags: recursesubdirs; Components: {#COMPN_SCILAB}
;
