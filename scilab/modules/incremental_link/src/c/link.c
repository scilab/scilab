                                                 ...
                                                 
{
  ...
  if (*ilib >= 0) 
  {
	  if (getWarningMode()) sciprint(_("Link done.\n"));
  }
}
...
{
  if (getWarningMode()) sciprint(_("Sorry : Dynamic linking is not implemented.\n"));
}
...
void C2F(isciulink)(i) 
     integer *i;
{
  if (getWarningMode()) sciprint(_("Sorry : Unlinking is not implemented.\n"));
}
