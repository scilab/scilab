...
//  PROGRAMME DA4-11 : Structure dynamique A : division sur place de quasi-carr�s sans effet d'�chelle
...
clear;
mprintf ("\nPROGRAMME DA4-11 : Structure dynamique A sur quasi-carr�s sans adresse\n");
...
rectc (1,1) = 0 ;     // x coin sup�rieur gauche
rectc (2,1) = haut ;  // y coin sup�rieur gauche
...
nd = 0;
hf = scf (0);
nomfenetre = sprintf ("DA4-11 : Division num�ro %d/%d",nd,ndivi);
