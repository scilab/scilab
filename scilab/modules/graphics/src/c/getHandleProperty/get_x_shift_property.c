...
int get_x_shift_property(char *pobjUID)
{
    ...
    getGraphicObjectProperty(pobjUID, __GO_DATA_MODEL_X_COORDINATES_SHIFT_SET__, jni_int, &piValue);
    ...
    {
        getGraphicObjectProperty(pobjUID, __GO_DATA_MODEL_X_COORDINATES_SHIFT__, jni_double_vector, &shiftCoordinates);
