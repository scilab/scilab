...
int set_y_shift_property( sciPointObj * pobj, size_t stackPointer, int valueType, int nbRow, int nbCol )
{
    ...
    if( nbElement != 0 )
    {
        ...
        result = setGraphicObjectProperty(pobj->UID, __GO_DATA_MODEL_Y_COORDINATES_SHIFT__, shiftCoordinates, jni_double_vector, *numElements);
    ...
    else
    {
         ...
         */
        int shiftSet = 0;
        setGraphicObjectProperty(pobj->UID, __GO_DATA_MODEL_Y_COORDINATES_SHIFT_SET__, &shiftSet, jni_double_vector, 1);
    }
