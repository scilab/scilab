...
;
Source: thirdparty\jlatexmath-0.8.8.jar;DestDir: {app}\thirdparty; Components: {#COMPN_GRAPHICS}
Source: thirdparty\jlatexmath-fop-0.8.8.jar;DestDir: {app}\thirdparty; Components: {#COMPN_GRAPHICS}
;
