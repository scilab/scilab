...
;
Source: thirdparty\jlatexmath-0.8.9.jar;DestDir: {app}\thirdparty; Components: {#COMPN_GRAPHICS}
Source: thirdparty\jlatexmath-fop-0.8.9.jar;DestDir: {app}\thirdparty; Components: {#COMPN_GRAPHICS}
;
