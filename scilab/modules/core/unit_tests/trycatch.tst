...
clear a b xxxx
if execstr('try a=xxxx catch b=2;end','errcatch')<>276 then pause,end
if exists('a')==1|exists('b')==1 then pause,end


clear a b xxxx
if execstr('try a=1 catch b=2;end','errcatch')<>276 then pause,end
if exists('a')==1|exists('b')==1 then pause,end
...
comp(test);if test() then pause,end
...
deff('r=test()',[
    ...
    'r=exists(''a'')==1|exists(''b'')==0'
    'r=r|b<>2'],'n')
if execstr('test()','errcatch')<>276 then pause,end
...
if test() then pause,end
comp(test);if test() then pause,end
comp(test1);if test() then pause,end
