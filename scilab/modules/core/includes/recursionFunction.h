...
typedef enum { 
	RECURSION_ERROR = -1,
	RECURSION_CALL_EXEC1 = 1,
	RECURSION_CALL_EXECSTR = 2,
	RECURSION_CALL_GETF = 3,
	RECURSION_CALL_SAVE = 4,
	RECURSION_CALL_LOAD = 5,
	RECURSION_CALL_COMP = 6,
	RECURSION_CALL_DISP = 7,
	RECURSION_CALL_EXEC2 = 8
