...
types::Function::ReturnValue sci_tlist_or_mlist(types::typed_list &in, int _piRetCount, types::typed_list &out, const char *_pstrFunName)
{
    ...
    if (pS->getSize() > 0 && strcmp(pS->get(0), "r") == 0)
    {
