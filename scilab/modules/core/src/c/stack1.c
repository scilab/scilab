...
int C2F(getlistmat)(char *fname,integer *topk,integer *spos,integer *lnum,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*lnum > nv) {
    error_scilab(999,"%s : argument %d should be a list of size at least %d.",get_fname(fname,fname_len), Rhs+(*spos - *topk), *lnum);
    return FALSE_;
  }
...
int C2F(getrmat)(char *fname,integer *topk,integer *lw,integer *m,integer *n,integer *lr,unsigned long fname_len)
{
  ...
  if (it != 0) {
    error_scilab(202,"%s : Argument %d: wrong type argument expecting a real matrix.",get_fname(fname,fname_len), Rhs + (*lw - *topk));
    return FALSE_;
  }
  return TRUE_;
}
...
int C2F(matsize)(char *fname,integer *topk,integer *lw,integer *m,integer *n,unsigned long fname_len)
{
  ...
  if (  C2F(getmat)(fname, topk, lw, &it, &m1, &n1, &lr, &lc, fname_len)  == FALSE_)
    return FALSE_;
  if (*m != m1 || *n != n1) {
    error_scilab(205,"%s : Argument %d: wrong matrix size (%d,%d) expected.",get_fname(fname,fname_len), Rhs + (*lw - *topk), *m,*n);
    return FALSE_;
  }
  return  TRUE_;
}
...
int C2F(getmati)(char *fname,integer *topk,integer *spos,integer *lw,integer *it,integer *m,integer *n,integer *lr,integer *lc,int *inlistx,integer *nel,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 1) {
    if (*inlistx) 
      error_scilab(999,"%s : argument %d >(%d) should be a real or complex matrix.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nel);
    else 
      error_scilab(201,"%s : argument %d should be a real or complex matrix.",get_fname(fname,fname_len),
	       Rhs + (*spos - *topk));
    return  FALSE_;
  }
  *m = *istk(il + 1);
...
int C2F(cremat)(char *fname,integer *lw,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*lw + 1 >= Bot) {
    error_scilab(18,"%s : too many names.",get_fname(fname,fname_len));
    return FALSE_;
  }
...
int C2F(cremati)(char *fname,integer *stlw,integer *it,integer *m,integer *n,integer *lr,integer *lc,int *flagx,unsigned long fname_len)
{
  ...
  if ( (double) Err > -size ) {
    error_scilab(17,"%s : stack size exceeded (Use stacksize function to increase it).",get_fname(fname,fname_len));
    return FALSE_;
  };
  if (*flagx) {
    *istk(il ) = 1;
...
int C2F(getimati)(char *fname,integer *topk,integer *spos,integer *lw,integer *it,integer *m,integer *n,integer *lr,int *inlistx,integer *nel,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 8 ) {
    if (*inlistx) 
      error_scilab(999,"%s : argument %d >(%d) should be an int matrix.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nel);
    else 
      error_scilab(201,"%s : argument %d should be a real or complex matrix.",get_fname(fname,fname_len),Rhs + (*spos - *topk));
    return  FALSE_;
  }
  *m = *istk(il + 1);
  *n = *istk(il + 2);
...
int C2F(getbmati)(char *fname,integer *topk,integer *spos,integer *lw,integer *m,integer *n,integer *lr,int *inlistx,integer *nel,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 4) {
    if (*inlistx) 
      error_scilab(999,"%s : argument %d >(%d) should be a boolean matrix.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nel);
    else 
      error_scilab(208,"%s : argument %d should be a boolean matrix.",get_fname(fname,fname_len),
	       Rhs + (*spos - *topk));
    return FALSE_;
  };
  *m = *istk(il +1);
...
{
  if (*lw + 1 >= Bot) {
	error_scilab(18,"%s : too many names.","fakecrebmat");
    return FALSE_;
  }
...
int C2F(getlistsparse)(char *fname,integer *topk,integer *spos,integer *lnum,integer *it,integer *m,integer *n,integer *nel,integer *mnel,integer *icol,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*lnum > nv) {
    error_scilab(999,"%s : argument %d should be a list of size at least %d.",
...
int C2F(getsparsei)(char *fname,integer *topk,integer *spos,integer *lw,integer *it,integer *m,integer *n,integer *nel,integer *mnel,integer *icol,integer *lr,integer *lc,int *inlistx,integer *nellist,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 5) {
    if (*inlistx) 
      error_scilab(999,"%s : argument %d >(%d) should be a sparse matrix.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nellist);
    else 
      error_scilab(999,"%s : argument %d should be a sparse matrix.",get_fname(fname,fname_len), Rhs + (*spos - *topk));
    return FALSE_;
  }
  *m   = *istk(il + 1);
  *n   = *istk(il + 2);
...
int C2F(getlistvect)(char *fname,integer *topk,integer *spos,integer *lnum,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*m != 1 && *n != 1) {
    error_scilab(999,"%s : argument %d > (%d) should be a vector.",get_fname(fname,fname_len),Rhs + (*spos - *topk), *lnum);
    return  FALSE_;
  }
  return TRUE_;
} 
...
int C2F(getvect)(char *fname,integer *topk,integer *lw,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*m != 1 && *n != 1) {
    error_scilab(214,"%s : Argument %d: wrong type argument expecting a vector.",get_fname(fname,fname_len), Rhs + (*lw - *topk));
    return FALSE_;
  };
  return  TRUE_;
}
...
int C2F(getrvect)(char *fname,integer *topk,integer *lw,integer *m,integer *n,integer *lr,unsigned long fname_len)
{
  ...
  if (*m != 1 && *n != 1) {
    error_scilab(203,"%s : Argument %d: wrong type argument expecting a real vector.",get_fname(fname,fname_len), Rhs + (*lw - *topk));
    return FALSE_;
  }
  return TRUE_ ;
}
...
int C2F(vectsize)(char *fname,integer *topk,integer *lw,integer *n,unsigned long fname_len)
{
  ...
  if (*n != m1 * n1) {
    error_scilab(206,"%s : Argument %d wrong vector size (%d) expected.",get_fname(fname,fname_len), Rhs + (*lw - *topk), *n);
    return FALSE_;
  }
  return TRUE_;
} 
...
int C2F(getlistscalar)(char *fname,integer *topk,integer *spos,integer *lnum,integer *lr,unsigned long fname_len)
{
  ...
  if (m * n != 1) {
    error_scilab(999,"%s : argument %d > (%d) should be a scalar.",get_fname(fname,fname_len), Rhs+(*spos - *topk), *lnum);
    return FALSE_;
  }
  return TRUE_;
}
...
int C2F(getscalar)(char *fname,integer *topk,integer *lw,integer *lr,unsigned long fname_len)
{
  ...
  if (m * n != 1) {
    error_scilab(204,"%s : Argument 1: wrong type argument expecting a scalar or 'min' or 'max'.",get_fname(fname,fname_len),Rhs + (*lw - *topk));
    return FALSE_ ; 
  };
  return TRUE_;
} 
...
static int C2F(getwsmati)(char *fname,integer *topk,integer *spos,integer *lw,integer *m,integer *n,integer *ilr,integer *ilrd ,int *inlistx,integer *nel,unsigned long fname_len)
{
    ...
    if (*istk(il ) != 10) {
      if (*inlistx)
	error_scilab(999,"%s : argument %d >(%d) should be a matrix of strings.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nel);
      else 
	error_scilab(207,"%s : Argument %d : wrong type argument, expecting a matrix of strings",get_fname(fname,fname_len), Rhs + (*spos - *topk));
      return FALSE_;
    }
    *m = *istk(il + 1);
    *n = *istk(il + 2);
...
int C2F(getsmati)(char *fname,integer *topk,integer *spos,integer *lw,integer *m,integer *n,integer *ix,integer *j,integer *lr,integer *nlr,int *inlistx,int *nel,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 10 ) {
    if (*inlistx) 
      error_scilab(999,"%s : argument %d >(%d) should be a row vector.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nel);
    else 
      error_scilab(201,"%s : argument %d should be a real or complex matrix.",get_fname(fname,fname_len),
	       Rhs + (*spos - *topk));
    return  FALSE_;
...
int C2F(getilist)(char *fname,integer *topk,integer *lw,integer *n,integer *ix,integer *ili,unsigned long fname_len)
{
  ...
  if (itype < 15 || itype > 17) {
    error_scilab(210,"%s : Argument %d: wrong type argument, expecting a list.",get_fname(fname,fname_len) , Rhs + (*lw - *topk));
    return FALSE_;
  }
  *n = *istk(il +1);
  if (*ix <= *n) {
...
int C2F(getpoly)(char *fname,integer *topk,integer *lw,integer *it,integer *m,integer *n,char *namex,integer *namel,integer *ilp,integer *lr,integer *lc,unsigned long fname_len,unsigned long name_len)
{
  ...
  il = iadr(*Lstk(*lw ));
  if (*istk(il ) != 2) {
    error_scilab(212,"%s : Argument %d: wrong type argument, expecting a polynomial matrix.",get_fname(fname,fname_len), Rhs + (*lw - *topk));
    return FALSE_;
  } ;
  *m = *istk(il +1);
  *n = *istk(il +2);
...
int C2F(getonepoly)(char *fname,integer *topk,integer *lw,integer *it,integer *md,char *namex,integer *namel,integer *lr,integer *lc, unsigned long fname_len, unsigned long name_len)
{
  ...
  if (m * n != 1) {
    error_scilab(998,"%s : argument should be a polygon.",get_fname(fname,fname_len));
    return FALSE_;
  }
...
int C2F(getwimat)(char *fname,integer *topk,integer *lw,integer *m,integer *n,integer *lr,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 4) {
    error_scilab(213,"%s : Argument %d: wrong type argument, expecting a working\n		integer matrix",get_fname(fname,fname_len),Rhs + (*lw - *topk));
    return FALSE_;
  };
  *m = *istk(il + 1);
  *n = *istk(il + 2);
...
int C2F(crestringv)(char *fname,integer *spos,integer *ilorig,integer *lw,unsigned long fname_len)
{
  ...
  if (ierr != 0) {
    error_scilab(999,"Not enough memory");
    return FALSE_;
  }
  return TRUE_;
}
...
int C2F(getlistvectrow)(char *fname,integer *topk,integer *spos,integer *lnum,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (C2F(getmati)(fname, topk, spos, &ili, it, m, n, lr, lc, &c_true, lnum, fname_len)== 
    ...
    return FALSE_;
  if (*m != 1) {
    error_scilab(999,"%s : argument %d >(%d) should be a row vector.",get_fname(fname,fname_len),Rhs + (*spos - *topk), *lnum);
    return FALSE_;
  }
  return TRUE_;
} 
...
int C2F(getvectrow)(char *fname,integer *topk,integer *spos,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*m != 1) {
    error_scilab(999,"%s : argument %d should be a row vector.",get_fname(fname,fname_len),Rhs + (*spos - *topk));
    return FALSE_;
  }
  return TRUE_ ;
} 
...
int C2F(getlistvectcol)(char *fname,integer *topk,integer *spos,integer *lnum,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*n != 1) {
    error_scilab(999,"%s : argument %d >(%d) should be a column vector.", get_fname(fname,fname_len),Rhs + (*spos - *topk), *lnum);
    return FALSE_;
  }
  return TRUE_;
}
...
int C2F(getvectcol)(char *fname,integer *topk,integer *spos,integer *it,integer *m,integer *n,integer *lr,integer *lc,unsigned long fname_len)
{
  ...
  if (*n != 1) {
    error_scilab(999,"%s : argument %d should be a column vector.",get_fname(fname,fname_len),Rhs + (*spos - *topk));
    return FALSE_;
  }
  return TRUE_;
}
...
int C2F(getpointeri)(char *fname,integer *topk,integer *spos,integer *lw,integer *lr,int *inlistx,integer *nel,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 128) {
    ...
    if (*inlistx) 
      error_scilab(197,"%s : argument %d >(%d) should be a boxed pointer.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nel);
    else 
      error_scilab(198,"%s : argument %d should be a boxed pointer.",get_fname(fname,fname_len),
	       Rhs + (*spos - *topk));
    return  FALSE_;
  }
  *lr = sadr(il+4);
...
int C2F(allmat)(char *fname,integer *topk,integer *lw,integer *m,integer *n,unsigned long fname_len)
{
  ...
  if (itype != 1 && itype != 2 && itype != 10) {
    error_scilab(209,"%s : Argument %d wrong type argument, expecting a matrix",get_fname(fname,fname_len) ,  Rhs + (*lw - *topk));
    return FALSE_;
  }
  *m = *istk(il + 1);
  *n = *istk(il + 2);
...
int C2F(getexternal)(char *fname,integer *topk,integer *lw,char *namex,int *typex,void (*setfun) __PARAMS((char *,int *)),unsigned long fname_len,unsigned long name_len)
{
  ...
  case 10 :
    ...
    *typex = TRUE_;
	...
	if (irep == 1) 
	  {
	    error_scilab(50,"%s : entry point %s not found in predefined tables or link table.",get_fname(fname,fname_len),namex);
	    ret_value = FALSE_;
	  }
      }
    break;
  default: 
    error_scilab(211,"%s : Argument %d: wrong type argument, expecting a function\n		or string (external function).",get_fname(fname,fname_len), Rhs + (*lw - *topk));
    ret_value = FALSE_;
    break;
  }
  return ret_value;
...
int C2F(checkval)(char *fname,integer *ival1,integer *ival2,unsigned long fname_len)
{
  if (*ival1 != *ival2) 
  {
    error_scilab(999,"%s : incompatible sizes.",get_fname(fname,fname_len));
    return  FALSE_;
  } ;
  return  TRUE_;
}
...
int C2F(optvarget)(char *fname,integer *topk,integer *iel,char *namex,unsigned long fname_len,unsigned long name_len)
{
  ...
  C2F(stackg)(id);
  if (Fin == 0) {
    error_scilab(999,"%s : optional argument %d not given and default value %s not found.",get_fname(fname,fname_len),*iel,namex);
    return FALSE_;
  }
  ++Rhs;
  return TRUE_;
...
int C2F(bufstore)(char *fname,integer *lbuf,integer *lbufi,integer *lbuff,integer *lr,integer *nlr,unsigned long fname_len)
{
  ...
  *lbuf = *lbuff + 2;
  if (*lbuff > bsiz) {
    error_scilab(999,"%f: No more space to store string arguments.",get_fname(fname,fname_len) );
    return FALSE_;
  }
...
int C2F(gethmati)(char *fname,integer *topk,integer *spos,integer *lw,integer *m,integer *n,integer *lr,int *inlistx,integer *nel,unsigned long fname_len)
{
  ...
  if (*istk(il ) != 9) {
    if (*inlistx) 
      error_scilab(999,"%s : argument %d >(%d) should be a matrix of handle.",get_fname(fname,fname_len), Rhs + (*spos - *topk), *nel);
    else 
      error_scilab(200,"%s : argument %d should be a matrix of handle.",get_fname(fname,fname_len),
	       Rhs + (*spos - *topk));
    return  FALSE_;
  }
  *m = *istk(il + 1);
