...
public final class SplitHorizontallyAction extends DefaultAction {
         ...
         */
        public SplitHorizontallyAction(Xpad editor) {
                super(XpadMessages.SPLIT_HORIZONTALLY, editor);
        }
        ...
        public static MenuItem createMenu(Xpad editor, KeyStroke key) {
            return createMenu(XpadMessages.SPLIT_HORIZONTALLY, null, new SplitHorizontallyAction(editor), key);
        }
