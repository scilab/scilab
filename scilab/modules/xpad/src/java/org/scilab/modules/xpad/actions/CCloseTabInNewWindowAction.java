...
public final class CCloseTabInNewWindowAction extends DefaultAction {
     ...
     */
    public CCloseTabInNewWindowAction(Xpad editor) {
        super(XpadMessages.CCLOSE_TAB_IN_NEW_WINDOW, editor);
    }
    ...
    public static MenuItem createMenu(Xpad editor, KeyStroke key) {
        return createMenu(XpadMessages.CCLOSE_TAB_IN_NEW_WINDOW, null, new CCloseTabInNewWindowAction(editor), key);
    }
