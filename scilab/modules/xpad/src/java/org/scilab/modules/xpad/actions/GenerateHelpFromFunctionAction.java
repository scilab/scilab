...
public class GenerateHelpFromFunctionAction extends DefaultAction {
     ...
     * @param editor Xpad
     */
    private GenerateHelpFromFunctionAction(Xpad editor) {
        super(XpadMessages.GENERATE_HELP, editor);
    }
    ...
    public static MenuItem createMenu(Xpad editor, KeyStroke key) {
        return createMenu(XpadMessages.GENERATE_HELP, null, new GenerateHelpFromFunctionAction(editor), key);
    }
}
