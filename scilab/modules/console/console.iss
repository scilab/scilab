...
;
;Source: java\jar\modules\console.jar;DestDir: {app}\java\jar\modules; Components: {#COMPN_CONSOLE}
;
;
...
;
Source: modules\{#CONSOLE}\sci_gateway\console_gateway.xml; DestDir: {app}\modules\{#CONSOLE}\sci_gateway; Components: {#COMPN_CONSOLE}
;
...
;
;Source: modules\{#CONSOLE}\demos\*.*; DestDir: {app}\modules\{#CONSOLE}\demos; Flags: recursesubdirs; Components: {#COMPN_CONSOLE}
;
;--------------------------------------------------------------------------------------------------------------
