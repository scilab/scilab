...
namespace types
{
  ...
  ro_setter_func(typed_list&, int, typed_list&, const Method::MethodCallCtx &)
  {
  ...
  Callable::ReturnValue
  BoundMethod::inner_call(typed_list &in, int iRetCount, typed_list &out)
  {
  ...
  Callable::ReturnValue
  BoundGetter::inner_call(typed_list &in, int retCount, typed_list &out)
  {
  ...
  Callable::ReturnValue
  BoundSetter::inner_call(typed_list &in, int retCount, typed_list &out)
  {
    Callable::ReturnValue ret;
  ...
  /** Root object */
  Callable::ReturnValue
  install_property(typed_list &in, int retCount, typed_list &, const Method::MethodCallCtx &ctx)
  {
  ...
  Callable::ReturnValue
  install_method(typed_list &in, int retCount, typed_list &, const Method::MethodCallCtx &ctx)
  {
    String *name = dynamic_cast<String*>(in[0]);
    String *visibility = NULL;
    Callable *func = NULL;
  ...
  Callable::ReturnValue
  object_get(typed_list &in, int retCount, typed_list &out, const Method::MethodCallCtx &ctx)
  {
    if(in.size() != 1)
      return Callable::Error;
  ...
  Callable::ReturnValue
  object_set(typed_list &in, int retCount, typed_list &out, const Method::MethodCallCtx &ctx)
  {
    if(in.size() != 2)
      return Callable::Error;
  ...
  Callable::ReturnValue
  slots_list(typed_list &in, int retCount, typed_list &out, const Method::MethodCallCtx &ctx)
  {
    if(in.size() > 1)
      return Callable::Error;
  ...
  Callable::ReturnValue
  remove_slot(typed_list &in, int retCount, typed_list &out, const Method::MethodCallCtx &ctx)
  {
    String *name = dynamic_cast<String*>(in[0]);
