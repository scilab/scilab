...
namespace types
{
  ...
  Object *
  ObjectMatrix::elem_get(int pos) const
  {
    return m_optr[pos];
  }
  
  bool
  ObjectMatrix::elem_set(int row, int col, Object *val)
  {
  ...
  bool
  ObjectMatrix::elem_set(int pos, Object *val)
  {
    if(m_repr == NULL)
    {
  ...
  bool
  ObjectMatrix::insert(int row, int col, const ObjectMatrix *other)
  {
