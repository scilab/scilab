...
template<> bool get(types::Bool CONST& d, int r, int c){ return d.bool_get(r, c); }
template<> int get(types::Bool CONST& d, int r, int c){ return d.bool_get(r, c); }
template<> bool get(types::SparseBool CONST& d, int r, int c){ return d.bool_get(r, c); }
template<> int get(types::SparseBool CONST& d, int r, int c){ return d.bool_get(r, c); }
...
template<> bool set(types::Bool & d, int r, int c, bool v){ return d.bool_set(r, c, v); }
template<> bool set(types::SparseBool & d, int r, int c, bool v){ return d.bool_set(r, c, v); }
template<> bool set(types::Bool & d, int r, int c, int v){ return d.bool_set(r, c, v); }
template<> bool set(types::SparseBool & d, int r, int c, int v){ return d.bool_set(r, c, v); }
...
template<> int rows(types::Bool CONST&s) { return s.rows_get();}
template<> int cols(types::Bool CONST&s) { return s.cols_get();}
template<> int rows(types::SparseBool CONST&s) { return s.rows_get();}
template<> int cols(types::SparseBool CONST&s) { return s.cols_get();}
...
{
    return RowWiseFullIterator(d.rows_get(), d.cols_get());
}
