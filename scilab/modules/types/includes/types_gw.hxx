...
Function::ReturnValue sci_cell(types::typed_list &in, int _iRetCount, types::typed_list &out);
Function::ReturnValue sci_makecell(types::typed_list &in, int _iRetCount, types::typed_list &out);
