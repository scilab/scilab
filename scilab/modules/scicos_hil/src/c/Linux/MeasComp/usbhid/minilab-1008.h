...
#define DIO_AUXPORT   (0x10)  // DIO0 - DIO3 on screw terminal
...
/* Commands and Codes for miniLABG 1008 HID reports */
...
__u8 usbDBitIn_USB1208_LS(int fd, __u8 port, __u8 bit);
