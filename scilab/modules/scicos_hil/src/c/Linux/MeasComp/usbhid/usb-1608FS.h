...
#define UPDATE_CODE      (0x54) // Update program memory
...
void usbAOut_USB1608FS(int fd, __u8 channel, __u16 value);
void usbAOutStop_USB1608FS(int fd);
...
void usbAInLoadQueue_USB1608FS(int fd, __u8 gains[8]);
