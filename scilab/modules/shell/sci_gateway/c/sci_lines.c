...
#include "sci_mode.h"
/*--------------------------------------------------------------------------*/
static int sci_lines_no_rhs(char *fname, int *pvApiCtx);
static int sci_lines_one_rhs(char *fname, int *pvApiCtx);
static int sci_lines_two_rhs(char *fname, int *pvApiCtx);
/*--------------------------------------------------------------------------*/
int sci_lines(char *fname, int *pvApiCtx)
{
    CheckRhs(0,2);
    CheckLhs(1,1);
