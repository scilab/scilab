 ...
 * @param ls
*/
METANET_IMPEXP void NodesToPath(int *nodes,int **p,int *psize,int *la,int *lp,int *ls);
...
*/
METANET_IMPEXP void C2F(prevn2p)(int *i,int *j,int *m,int *n,int *la,int *lp,int *ls,int *direct,int *pln,int **p,int *psize);
 ...
 * *psize = *nsize - 1 
*/
METANET_IMPEXP void C2F(ns2p)(int *nodes,int *nsize,int **p,int *psize,int *la,int *lp,int *ls,int *n);
 ...
 * with *nsize = *psize + 1 
*/
METANET_IMPEXP void C2F(p2ns)(int *p,int *psize,int **nodes,int *nsize,int *la,int *lp,int *ls,int *direct,int *m,int *n);
 ...
 */
METANET_IMPEXP void C2F(edge2st)(int *n,int *alpha,int **tree,int *treesize);
...
METANET_IMPEXP void C2F(prevn2st)(int *n,int *nodes,int **tree,int *treesize,int *la,int *lp,int *ls);
