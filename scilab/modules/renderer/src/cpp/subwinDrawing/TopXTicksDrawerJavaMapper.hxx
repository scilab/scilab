/*------------------------------------------------------------------------*/
/* file: TopXTicksDrawerJavaMapper.hxx                                    */
/* Copyright INRIA 2007                                                   */
/* Authors : Jean-Baptiste Silvy                                          */
/* desc : Class containing java methods needed by XTicksDrawerJoGL        */
/*------------------------------------------------------------------------*/

#ifndef _TOP_X_TICKS_DRAWER_JAVA_MAPPER_HXX_
#define _TOP_X_TICKS_DRAWER_JAVA_MAPPER_HXX_
 ...
 */
class TopXTicksDrawerJavaMapper : public virtual TicksDrawerJavaMapper
{
public:

  TopXTicksDrawerJavaMapper(void);

  virtual ~TopXTicksDrawerJavaMapper(void);
  /*----------------------------------------------------------------------*/
...
protected:
   ...
   */
  org_scilab_modules_renderer_subwinDrawing::TopXTicksDrawerGL * m_pJavaObject;
