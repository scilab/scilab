...
#ifndef _TOP_X_AXIS_POSITIONER_HXX_
#define _TOP_X_AXIS_POSITIONER_HXX_
 ...
 */
class TopXAxisPositioner : public XAxisPositioner
{
public:

  TopXAxisPositioner(DrawableSubwin * subwin);

  virtual ~TopXAxisPositioner(void);
