...
#ifndef _LEFT_YTICKS_POSITIONNER_HXX_
#define _LEFT_YTICKS_POSITIONNER_HXX_
...
/**
 * Class positionnign ticks for y_location = left
 */
class LeftYTicksPositioner : public YTicksPositioner
{
public:

  LeftYTicksPositioner(DrawableSubwin * subwin);

  virtual ~LeftYTicksPositioner(void);
...
#endif /* _LEFT_YTICKS_POSITIONNER_HXX_ */
