...
#ifndef _LEFT_Y_AXIS_POSITIONER_HXX_
#define _LEFT_Y_AXIS_POSITIONER_HXX_
 ...
 */
class LeftYAxisPositioner : public YAxisPositioner
{
public:

  LeftYAxisPositioner(DrawableSubwin * subwin);

  virtual ~LeftYAxisPositioner(void);
