...
#ifndef _X_AXIS_POSITIONER_HXX_
#define _X_AXIS_POSITIONER_HXX_
 ...
 */
class XAxisPositioner : public SubwinAxisPositioner
{
public:

  XAxisPositioner(DrawableSubwin * subwin);

  virtual ~XAxisPositioner(void);
