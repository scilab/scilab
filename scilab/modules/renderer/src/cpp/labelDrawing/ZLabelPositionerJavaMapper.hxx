/*------------------------------------------------------------------------*/
/* file: ZLabelPositionerJavaMapper.hxx                                   */
/* Copyright INRIA 2008                                                   */
/* Authors : Jean-Baptiste Silvy                                          */
/* desc : Class containing java methods needed by XLabelPositionerJoGL    */
/*------------------------------------------------------------------------*/

#ifndef _Z_LABEL_POSITIONER_JAVA_MAPPER_HXX_
#define _Z_LABEL_POSITIONER_JAVA_MAPPER_HXX_

#include "LabelPositionerJavaMapper.hxx"
#include "ZLabelPositionerGL.hxx"
...
*/
class ZLabelPositionerJavaMapper : public virtual LabelPositionerJavaMapper
{
public:

  ZLabelPositionerJavaMapper(void);

  virtual ~ZLabelPositionerJavaMapper(void);
  /*----------------------------------------------------------------------*/
...
protected:
   ...
   */
  org_scilab_modules_renderer_labelDrawing::ZLabelPositionerGL * m_pJavaObject;
