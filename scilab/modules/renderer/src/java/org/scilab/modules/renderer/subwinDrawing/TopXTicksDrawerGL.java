/*------------------------------------------------------------------------*/
/* file: TopXTicksDrawerGL.java                                           */
/* Copyright INRIA 2007                                                   */
/* Authors : Jean-Baptiste Silvy                                          */
/* desc : Class drawing ticks on of X axis placed on top of the           */
/*        axes box                                                        */
/*------------------------------------------------------------------------*/
...
/**
 * Class drawing ticks on of X axis placed on top of the axes box
 * @author Jean-Baptiste Silvy
 */
public class TopXTicksDrawerGL extends XTicksDrawerGL {

	/**
	 * Default constructor
	 */
	public TopXTicksDrawerGL() {
		super();
	}
