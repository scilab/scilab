...
public abstract class ExportRenderer implements GLEventListener {
    ...
    static {
        errors.put(ExportRenderer.SUCCESS, "");
    ...
    static {
        types.put("bmp", BMP_EXPORT);
        types.put("gif", GIF_EXPORT);
        types.put("jpg", JPG_EXPORT);
        types.put("png", PNG_EXPORT);
        types.put("ppm", PPM_EXPORT);
        types.put("eps", EPS_EXPORT);
        types.put("pdf", PDF_EXPORT);
        types.put("svg", SVG_EXPORT);
        types.put("ps", PS_EXPORT);
    }
