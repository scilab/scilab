<<<<<<< HEAD:scilab/modules/elementary_functions/tests/nonreg_tests/bug_3520.tst
// =============================================================================
...
if or(ref_table<>table) then pause,end
if or(ref_idx<>idx) then pause,end
>>>>>>> refs/heads/5.0:scilab/modules/elementary_functions/tests/nonreg_tests/bug_3520.tst
