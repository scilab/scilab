...
if ~isnan(gamma(-1.e308))    then pause, end
assert_close ( gamma(-170.6) ,  -2.082900836150297478e-308 , %eps );
assert_close ( gamma(-1.5) , 2.36327180120735480529 , %eps );
if ~isnan(gamma(-2.))    then pause, end
if ~isnan(gamma(-1.))    then pause, end
