...
| DOLLAR					{ $$ = new ast::StringExp(@$, std::string("$")); }
| BOOLTRUE					{ $$ = new ast::StringExp(@$, std::string("%t")); }
| BOOLFALSE					{ $$ = new ast::StringExp(@$, std::string("%f")); }
...
/*   '\'   '.\'   '.\.'   '\.'   */
| LDIVIDE variable			{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::ldivide, *$2); }
| LDIVIDE functionCall			{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::ldivide, *$2); }
| DOTLDIVIDE variable			{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::dotldivide, *$2); }
| DOTLDIVIDE functionCall		{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::dotldivide, *$2); }
| KRONLDIVIDE variable			{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::kronldivide, *$2); }
| KRONLDIVIDE functionCall		{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::kronldivide, *$2); }
| CONTROLLDIVIDE variable			{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::controlldivide, *$2); }
| CONTROLLDIVIDE functionCall		{ $$ = new ast::OpExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), ast::OpExp::controlldivide, *$2); }
;
...
listableEnd :
listableBegin COLON variable		{ $$ = new ast::ListExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), *$1, *$3, true); }
| listableBegin COLON functionCall	{ $$ = new ast::ListExp(@$, *new ast::CommentExp(@$, new std::string("Should not stay in that state")), *$1, *$3, true); }
...
keywords :
IF              { $$ = new ast::SimpleVar(@$, symbol::Symbol("if")); }
| THEN          { $$ = new ast::SimpleVar(@$, symbol::Symbol("then")); }
| ELSE          { $$ = new ast::SimpleVar(@$, symbol::Symbol("else")); }
| ELSEIF        { $$ = new ast::SimpleVar(@$, symbol::Symbol("elseif")); }
| END           { $$ = new ast::SimpleVar(@$, symbol::Symbol("end")); }
| SELECT        { $$ = new ast::SimpleVar(@$, symbol::Symbol("select")); }
| SWITCH        { $$ = new ast::SimpleVar(@$, symbol::Symbol("switch")); }
| OTHERWISE     { $$ = new ast::SimpleVar(@$, symbol::Symbol("otherwise")); }
| CASE          { $$ = new ast::SimpleVar(@$, symbol::Symbol("case")); }
| FUNCTION      { $$ = new ast::SimpleVar(@$, symbol::Symbol("function")); }
| ENDFUNCTION   { $$ = new ast::SimpleVar(@$, symbol::Symbol("endfunction")); }
| FOR           { $$ = new ast::SimpleVar(@$, symbol::Symbol("for")); }
| WHILE         { $$ = new ast::SimpleVar(@$, symbol::Symbol("while")); }
| DO            { $$ = new ast::SimpleVar(@$, symbol::Symbol("do")); }
| BREAK         { $$ = new ast::SimpleVar(@$, symbol::Symbol("break")); }
| TRY           { $$ = new ast::SimpleVar(@$, symbol::Symbol("try")); }
| CATCH         { $$ = new ast::SimpleVar(@$, symbol::Symbol("catch")); }
| RETURN        { $$ = new ast::SimpleVar(@$, symbol::Symbol("return")); }
;
