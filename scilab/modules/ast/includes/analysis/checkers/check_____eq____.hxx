...
#ifndef __CHECK_____EQ_____HXX__
#define __CHECK_____EQ_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____eq____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____eq_____HXX__