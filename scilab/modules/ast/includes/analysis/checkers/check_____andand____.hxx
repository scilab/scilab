...
#ifndef __CHECK_____ANDAND_____HXX__
#define __CHECK_____ANDAND_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____andand____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____andand_____HXX__