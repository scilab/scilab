...
#ifndef __CHECK_____DOTTRANSP_____HXX__
#define __CHECK_____DOTTRANSP_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____dottransp____(GVN & gvn, const TIType & in0)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____dottransp_____HXX__