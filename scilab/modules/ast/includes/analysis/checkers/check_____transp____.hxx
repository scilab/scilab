...
#ifndef __CHECK_____TRANSP_____HXX__
#define __CHECK_____TRANSP_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____transp____(GVN & gvn, const TIType & in0)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____transp_____HXX__