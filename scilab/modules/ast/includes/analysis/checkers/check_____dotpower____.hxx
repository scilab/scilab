...
#ifndef __CHECK_____DOTPOWER_____HXX__
#define __CHECK_____DOTPOWER_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____dotpower____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____dotpower_____HXX__