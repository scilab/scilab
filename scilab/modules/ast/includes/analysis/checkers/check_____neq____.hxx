...
#ifndef __CHECK_____NEQ_____HXX__
#define __CHECK_____NEQ_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____neq____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____neq_____HXX__