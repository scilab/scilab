...
#ifndef __CHECK_MATRIX_HXX__
#define __CHECK_MATRIX_HXX__

#include "TIType.hxx"

namespace analysis
{
    inline static TIType check_matrix(GVN & gvn, const TIType & in0, const TIType & in1)
    {
        switch (in0.type)
        {
        case TIType::EMPTY :
    ...
    inline static TIType check_matrix(GVN & gvn, const TIType & in0, const TIType & in1, const TIType & in2)
    {
        switch (in0.type)
        {
        case TIType::EMPTY :
