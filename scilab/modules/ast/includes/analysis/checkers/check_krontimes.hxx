...
#ifndef __CHECK_KRONTIMES_HXX__
#define __CHECK_KRONTIMES_HXX__

#include "TIType.hxx"

namespace analysis
{
    inline static TIType check_krontimes(GVN & gvn, const TIType & in0, const TIType & in1)
    {
        switch (in0.type)
        {
        case TIType::EMPTY :
