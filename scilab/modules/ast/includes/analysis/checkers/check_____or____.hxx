...
#ifndef __CHECK_____OR_____HXX__
#define __CHECK_____OR_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____or____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____or_____HXX__