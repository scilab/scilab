...
#ifndef __CHECK_____DOTTIMES_____HXX__
#define __CHECK_____DOTTIMES_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____dottimes____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____dottimes_____HXX__