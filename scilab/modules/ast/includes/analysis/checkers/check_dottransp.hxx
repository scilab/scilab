...
#ifndef __CHECK_DOTTRANSP_HXX__
#define __CHECK_DOTTRANSP_HXX__

#include "TIType.hxx"

namespace analysis
{
    inline static TIType check_dottransp(GVN & gvn, const TIType & in0)
    {
        switch (in0.type)
        {
        case TIType::EMPTY :
