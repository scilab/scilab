...
#ifndef __CHECK_____TIMES_____HXX__
#define __CHECK_____TIMES_____HXX__

#include "TIType.hxx"

namespace analysis
{
inline static TIType check_____times____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
...
#endif // __CHECK_____times_____HXX__