...
#ifndef __JIT_ABS_HXX__
#define __JIT_ABS_HXX__
...
namespace jit
{
    ...
    class JITAbs : public JITOptimizedCall1
    {
    public:
	
        JITAbs() : JITOptimizedCall1("abs", {{ }}, llvm::Intrinsic::fabs) { }
