...
namespace jit
{
    ...
    public:
        ...
        JITOptimizedCall1(const::string & _jitName, const std::map<analysis::TIType::Type, std::string> & _map, const llvm::Intrinsic::ID _id = llvm::Intrinsic::not_intrinsic) : jitName(_jitName), map(_map), id(_id) { }
	JITOptimizedCall1(const::string & _jitName, const llvm::Intrinsic::ID _id = llvm::Intrinsic::not_intrinsic) : jitName(_jitName), id(_id) { }
