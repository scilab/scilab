...
#ifndef __JIT_CEIL_HXX__
#define __JIT_CEIL_HXX__
...
namespace jit
{
    ...
    class JITCeil : public JITOptimizedCall1
    {
    public:
	
        JITCeil() : JITOptimizedCall1("ceil", {{ }}, llvm::Intrinsic::ceil) { }
