...
#ifndef __JIT_ROUND_HXX__
#define __JIT_ROUND_HXX__
...
namespace jit
{
    ...
    class JITRound : public JITOptimizedCall1
    {
    public:
	
        JITRound() : JITOptimizedCall1("round", {{ }}, llvm::Intrinsic::round) { }
