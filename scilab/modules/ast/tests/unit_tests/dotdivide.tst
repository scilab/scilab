...
assert_checkequal(c .\ e, (0.2-%i*0.4)*eye());
...
assert_checkequal(e .\ SP1, sparse([1,1],10,[1,1]));
assert_checkequal(e .\ SPC1, sparse([1,1],2+%i*6,[1,1]));
...
assert_checkequal(e ./ c, (0.2-%i*0.4)*eye());
assert_checkequal(e ./ e, (1)*eye());
assert_checkequal(e ./ ec, (5/26-%i* 1/26)*eye());
assert_checkequal(e ./ SP1, sparse([1,1],0.1,[1,1]));
assert_checkalmostequal(e ./ SPC1, sparse([1,1],0.05-%i*0.15,[1,1]));
