...
;
Source: modules\{#AST}\includes\*.*; DestDir: {app}\modules\{#AST}\includes; Components: {#COMPN_SCILAB}
...
Source: modules\{#AST}\includes\operation\*.*; DestDir: {app}\modules\{#AST}\includes\operation; Components: {#COMPN_SCILAB}
