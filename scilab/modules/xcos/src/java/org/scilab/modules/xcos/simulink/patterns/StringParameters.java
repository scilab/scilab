 ...
 *       &lt;sequence>
 *         &lt;element name="map" type="{}StringValueMap" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class StringParameters {
    ...
    protected List<StringValueMap> map;
     ...
     * 
     */
    public List<StringValueMap> getMap() {
        if (map == null) {
            map = new ArrayList<StringValueMap>();
        }
        return this.map;
    }
