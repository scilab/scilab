...
public final class LabelWithValue extends JPanel {
	...
	private static final Icon ERROR_ICON = (Icon) UIManager.get("OptionPane.errorIcon");
	private static final Icon MESSAGE_ICON = (Icon) UIManager.get("OptionPane.informationIcon");
	 ...
	 * @param column the number of column visible
	 */
	 ...
	 * @param b the status of the value
	 */
	 ...
	 * @param error true, if the error is set, false otherwise.
	 */
