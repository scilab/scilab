...
public final class ModelicaMessages {
	public static final String MODELICA_SETTINGS = Messages.gettext("Modelica settings");
	...
	public static final String FIX_DERIVATIVES = Messages.gettext("Fix derivatives");
	public static final String FIX_STATES = Messages.gettext("Fix states");

	public static final String SOLVE = Messages.gettext("Solve");
	public static final String MODEL_INVALID = Messages.gettext("model is not valid");
	...
	public static final String INITIAL_COMPUTING_METHOD = Messages.gettext("Initial computing method");
	public static final String PARAMETER_EMBEDDING = Messages.gettext("Parameter embedding");
	public static final String PARAMETER_EMBEDDING_EXPLAINED = Messages.gettext("lets the user change the parameters and call the solver without regenerating code.");
	public static final String GENERATE_JACOBIAN = Messages.gettext("Generate Jacobian");
	public static final String ERROR = Messages.gettext("Error");
	public static final String UNKNOWNS_NEQ_EQUATIONS = Messages.gettext("Unknowns not equals to Equations");
	...
	public static final String FIXED_PARAMS = Messages.gettext("Fixed parameters");
	public static final String RELAXED_PARAMS = Messages.gettext("Relaxed parameters");
	public static final String FIXED_VARIABLES = Messages.gettext("Fixed variables");
	public static final String RELAXED_VARIABLES = Messages.gettext("Relaxed variables");

	public static final String TAKE_A_LOOK_AT_SCILAB = Messages.gettext("Please take a look into the Scilab console");
