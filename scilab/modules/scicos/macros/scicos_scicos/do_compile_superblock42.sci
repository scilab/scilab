      ...
      if writeGlobal <> []
          for i = 1:size(writeGlobal, '*')
              mputl(['/*---------------------------------------- Write variable '+writeGlobal(i)+' */'
                     ...
                     '    if (flag == 4)'
                     '    {'
                     '        memset(global_'+writeGlobal(i)+', 0x0, global_'+writeGlobal(i)+'_Size * sizeof(double));'
                     '        global_'+writeGlobal(i)+'_Index = -2;'
                     '    }'
                     ''
                     '    /* output update */'
                     '    if (flag == 1)'
                     ...
                     '        global_'+writeGlobal(i)+'[global_'+writeGlobal(i)+'_Index] = ((double *) block->inptr[0])[0];'
                     '    }'
                     '}'
                    ], fd);
          end
