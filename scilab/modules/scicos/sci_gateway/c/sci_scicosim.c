    ...
    if (ierr > 0)
    {
        switch (ierr)
        {
            ...
            case 26  :
                ...
                /* IDA error messages*/
            case 201  :
                strcpy(C2F(cha1).buf, _("IDA_TOO_MUCH_WORK: The solver took mxstep internal steps but could not reach tout. The default value for mxstep is MXSTEP_DEFAULT = 500."));
                break;

            case 202  :
                strcpy(C2F(cha1).buf, _("IDA_TOO_MUCH_ACC: The solver could not satisfy the accuracy demanded by the user for some internal step."));
                break;

            case 203  :
                strcpy(C2F(cha1).buf, _("IDA_ERR_FAIL: Error test failures occurred too many times (=MXETF = 10) during one internal step or occurred with |h|=h_min"));
                break;

            case 204  :
                strcpy(C2F(cha1).buf, _("IDA_CONV_FAIL: IDACalcIC -> Failed to get convergence of the Newton iterations. or IDA_solve->Convergence test failures occurred too many times (= MXNCF = 10) during one internal step. "));
                break;

            case 205  :
                strcpy(C2F(cha1).buf, _("IDA_LINIT_FAIL: The linear solver''s initialization routine failed."));
                break;

            case 206  :
                strcpy(C2F(cha1).buf, _("IDA_LSETUP_FAIL: The linear solver''s setup routine had a non-recoverable error."));
                break;

            case 207  :
                strcpy(C2F(cha1).buf, _("IDA_LSOLVE_FAIL: The linear solver''s solve routine had a non-recoverable error."));
                break;

            case 208  :
                strcpy(C2F(cha1).buf, _("IDA_RES_FAIL: The user''s residual routine returned a non-recoverable error flag."));
                break;

            case 209  :
                strcpy(C2F(cha1).buf, _("IDA_REP_RES_ERR: The user''s residual function repeatedly returned a recoverable error flag, but the solver was unable to recover."));
                break;

            case 210  :
                strcpy(C2F(cha1).buf, _("IDA_RTFUNC_FAIL: The root founding function failed."));
                break;

            case 211  :
                strcpy(C2F(cha1).buf, _("IDA_CONSTR_FAIL: IDACalcIC was unable to find a solution satisfying the inequality constraints."));
                break;

            case 212  :
                strcpy(C2F(cha1).buf, _("IDA_FIRST_RES_FAIL: The user''s residual routine returned  a recoverable error flag on the first call, but IDACalcIC was unable to recover."));
                break;

            case 213  :
                strcpy(C2F(cha1).buf, _("IDA_LINESEARCH_FAIL: The Linesearch algorithm failed to find a solution with a step larger than steptol in weighted RMS norm."));
                break;

            case 214  :
                strcpy(C2F(cha1).buf, _("IDA_NO_RECOVERY: The user''s residual routine, or the linear solver''s setup or solve routine had a recoverable error, but IDACalcIC was unable to recover."));
                break;

            case 220  :
                strcpy(C2F(cha1).buf, _("IDA_MEM_NULL: The argument ida_mem was NULL"));
                break;

            case 221  :
                strcpy(C2F(cha1).buf, _("IDA_MEM_FAIL: A memory allocation failed."));
                break;

            case 222  :
                strcpy(C2F(cha1).buf, _("IDA_ILL_INPUT: One of the input arguments was illegal. This errors message may be returned if the linear solver function initialization (called by the user after calling IDACreate) failed to set the linear solver-specific lsolve field in ida_mem."));
                break;

            case 223  :
                strcpy(C2F(cha1).buf, _("IDA_NO_MALLOC: Indicating that ida_mem was not allocated."));
                break;

            case 224  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_EWT: Some component of the error weight vector is zero (illegal), either for the input value of y0 or a corrected value."));
                break;

            case 225  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_K: k (the order of the derivative of y to be computed) is not in the range 0, 1, ..., qu, where qu is the order last used"));
                break;

            case 226  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_T: t is not in the interval [tn-hu,tn]."));
                break;

            case 227  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_DKY: The dky argument was NULL. dky is the output derivative vector [((d/dt)^k)y](t)."));
                break;

            case 228  :
                strcpy(C2F(cha1).buf, _("IDA_YOUT_NULL: ''yout'' = NULL illegal."));
                break;
            case 229  :
                strcpy(C2F(cha1).buf, _("IDA_TRET_NULL: ''tret'' = NULL illegal."));
                break;
            case 230  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_ITASK: Illegal value for itask."));
                break;
            case 231  :
                strcpy(C2F(cha1).buf, _("IDA_NO_ESTOP: itask = IDA_NORMAL_TSTOP or itask = IDA_ONE_STEP_TSTOP but tstop was not set"));
                break;
            case 232  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_H0: h0 and tout - t0 inconsistent."));
                break;
            case 233  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_TSTOP: tstop is behind current simulation time in the direction of integration."));
                break;
            case 234  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_INIT_ROOT: Root found at and very near initial t."));
                break;
            case 235  :
                strcpy(C2F(cha1).buf, _("IDA_NO_EFUN: itol = IDA_WF but no EwtSet function was provided."));
                break;
            case 236  :
                strcpy(C2F(cha1).buf, _("IDA_EWT_FAIL: The user-provide EwtSet function failed."));
                break;
            case 237  :
                strcpy(C2F(cha1).buf, _("IDACalc cannot find the initial condition at this point. If you are using a Modelica model, you can try with the initialization GUI to try with other nonlinear solvers."));
                break;
            case 238  :
                strcpy(C2F(cha1).buf, _("IDA_LSOLVE_NULL: The linear solver''s solve routine is NULL."));
                break;
            case 239  :
                strcpy(C2F(cha1).buf, _("IDA_NULL_Y0: y0 = NULL illegal."));
                break;
            case 240  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_ITOL: Illegal value for itol. The legal values are IDA_SS, IDA_SV, and IDA_WF."));
                break;
            case 241  :
                strcpy(C2F(cha1).buf, _("IDA_NULL_F: User-supplied ODE routine is (NULL) illegal."));
                break;
            case 242  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_NVECTOR: A required vector operation is not implemented."));
                break;
            case 243  :
                strcpy(C2F(cha1).buf, _("IDA_NULL_ABSTOL: absolute tolerances = NULL illegal."));
                break;
            case 244  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_RELTOL: relative tolerances is reltol < 0 illegal."));
                break;
            case 245  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_ABSTOL: abstol has negative component(s) (illegal)."));
                break;
            case 246  :
                strcpy(C2F(cha1).buf, _("IDA_NULL_G: User-supplied zero-crossing routine is (NULL) illegal."));
                break;
            case 247  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_TOUT: Trouble interpolating. ''tout'' too far back in direction of integration"));
                break;
            case 248  :
                strcpy(C2F(cha1).buf, _("IDA_YP0_NULL: The derivative yp0 = NULL is illegal."));
                break;
            case 249  :
                strcpy(C2F(cha1).buf, _("IDA_RES_NULL: The returned residual res = NULL is illegal."));
                break;
            case 250  :
                strcpy(C2F(cha1).buf, _("IDA_YRET_NULL: yret = NULL illegal.."));
                break;
            case 251  :
                strcpy(C2F(cha1).buf, _("IDA_YPRET_NULL: yret = NULL illegal.."));
                break;
            case 252  :
                strcpy(C2F(cha1).buf, _("IDA_BAD_HINIT: yret = NULL illegal.."));
                break;
            case 253  :
                strcpy(C2F(cha1).buf, _("IDA_MISSING_ID: id = NULL (''id'' defines algebraic and differential states) but suppressalg option on."));
                break;
            case 254  :
                strcpy(C2F(cha1).buf, _("IDA_Y0_FAIL_CONSTR: y0 fails to satisfy constraints."));
                break;
            case 255  :
                strcpy(C2F(cha1).buf, _("IDA_TOO_CLOSE: ''tout'' too close to ''t0'' to start integration."));
                break;
            case 256  :
                strcpy(C2F(cha1).buf, _("IDA_CLOSE_ROOTS: Root found at and very near starting time."));
                break;
            case 257  :
                strcpy(C2F(cha1).buf, _("IDA_Residual_NAN: The residual function returns NAN."));
                break;
            case 258  :
                strcpy(C2F(cha1).buf, _("IDA_Rootfunction_NAN: The Root function returns NAN."));
                break;

                /* CVODE error messages*/
            case 301  :
                strcpy(C2F(cha1).buf, _("CV_TOO_MUCH_WORK: The solver took mxstep internal steps but could not reach ''tout''. The default value for mxstep is MXSTEP_DEFAULT = 500."));
                break;

            case 302  :
                strcpy(C2F(cha1).buf, _("CV_TOO_MUCH_ACC: The solver could not satisfy the accuracy demanded by the user for some internal step"));
                break;

            case 303  :
                strcpy(C2F(cha1).buf, _("CV_ERR_FAILURE: Error test failures occurred too many times (=MXETF = 7) during one internal step or occurred with |h|=h_min "));
                break;

            case 304  :
                strcpy(C2F(cha1).buf, _("CV_CONV_FAILURE: Convergence test failures occurred too many times (= MXNCF = 10) during one internal time step or occurred with |h| = hmin."));
                break;

            case 305  :
                strcpy(C2F(cha1).buf, _("CV_LINIT_FAIL: The linear solver''s initialization function failed."));
                break;

            case 306  :
                strcpy(C2F(cha1).buf, _("CV_LSETUP_FAIL: The linear solver''s setup routine failed in an unrecoverable manner."));
                break;

            case 307  :
                strcpy(C2F(cha1).buf, _("CV_LSOLVE_FAIL: The linear solver''s solve routine failed in an unrecoverable manner."));
                break;

            case 308  :
                strcpy(C2F(cha1).buf, _("CV_RHSFUNC_FAIL: The right-hand side function (user supplied ODE) failed in an unrecoverable manner"));
                break;

            case 309  :
                strcpy(C2F(cha1).buf, _("CV_FIRST_RHSFUNC_ERR: The right-hand side function (user supplied ODE) had a recoverable error at the first call"));
                break;

            case 310  :
                strcpy(C2F(cha1).buf, _("CV_REPTD_RHSFUNC_ERR: Convergence tests occurred too many times due to repeated recoverable errors in the right-hand side function (user supplied ODE). This error may be raised due to repeated  recoverable errors during the estimation of an initial step size."));
                break;

            case 311  :
                strcpy(C2F(cha1).buf, _("CV_UNREC_RHSFUNC_ERR: The right-hand side function (user supplied ODE) had a recoverable error, but no recovery was possible."));
                break;
            case 312  :
                strcpy(C2F(cha1).buf, _("CV_RTFUNC_FAIL: The root finding routine failed in an unrecoverable manner."));
                break;
            case 320  :
                strcpy(C2F(cha1).buf, _("CV_MEM_FAIL: A memory allocation failed, including an attempt to increase maxord"));
                break;
            case 321  :
                strcpy(C2F(cha1).buf, _("CV_MEM_NULL: The cvode memory was NULL"));
                break;
            case 322  :
                ...
                break;
            case 323  :
                strcpy(C2F(cha1).buf, _("CV_NO_MALLOC: Indicating that cvode_mem has not been allocated (i.e., CVodeMalloc has not been called)."));
                break;
            case 324  :
                strcpy(C2F(cha1).buf, _("CV_BAD_K: k (the order of the derivative of y to be computed) is not in the range 0, 1, ..., qu, where qu is the order last used"));
                break;
            case 325  :
                strcpy(C2F(cha1).buf, _("CV_BAD_T: t is not in the interval [tn-hu,tn]."));
                break;
            case 326  :
                strcpy(C2F(cha1).buf, _("CV_BAD_DKY:  The dky argument was NULL. dky is the output derivative vector [((d/dt)^k)y](t)."));
                break;
            case 327  :
                strcpy(C2F(cha1).buf, _("CV_TOO_CLOSE: ''tout'' too close to ''t0'' to start integration."));
                break;
            case 328  :
                strcpy(C2F(cha1).buf, _("CV_YOUT_NULL: ''yout'' = NULL illegal."));
                break;
            case 329  :
                strcpy(C2F(cha1).buf, _("CV_TRET_NULL: ''tret'' = NULL illegal."));
                break;
            case 330  :
                strcpy(C2F(cha1).buf, _("CV_BAD_ITASK: Illegal value for itask."));
                break;
            case 331  :
                strcpy(C2F(cha1).buf, _("CV_NO_ESTOP: itask = CV_NORMAL_TSTOP or itask = CV_ONE_STEP_TSTOP but tstop was not set"));
                break;
            case 332  :
                strcpy(C2F(cha1).buf, _("CV_BAD_H0: h0 and tout - t0 inconsistent."));
                break;
            case 333  :
                strcpy(C2F(cha1).buf, _("CV_BAD_TSTOP: tstop is behind current simulation time in the direction of integration."));
                break;
            case 334  :
                strcpy(C2F(cha1).buf, _("CV_BAD_INIT_ROOT: Root found at and very near initial t."));
                break;
            case 335  :
                strcpy(C2F(cha1).buf, _("CV_NO_EFUN: itol = CV_WF but no EwtSet function was provided."));
                break;
            case 336  :
                strcpy(C2F(cha1).buf, _("CV_EWT_FAIL: The user-provide EwtSet function failed."));
                break;
            case 337  :
                strcpy(C2F(cha1).buf, _("CV_BAD_EWT: Initial ewt has component(s) equal to zero (illegal)."));
                break;
            case 338  :
                strcpy(C2F(cha1).buf, _("CV_LSOLVE_NULL: The linear solver''s solve routine is NULL."));
                break;
            case 339  :
                strcpy(C2F(cha1).buf, _("CV_NULL_Y0: y0 = NULL illegal."));
                break;
            case 340  :
                strcpy(C2F(cha1).buf, _("CV_BAD_ITOL: Illegal value for itol. The legal values are CV_SS, CV_SV, and CV_WF."));
                break;
            case 341  :
                strcpy(C2F(cha1).buf, _("CV_NULL_F: User-supplied ODE routine is (NULL) illegal."));
                break;
            case 342  :
                strcpy(C2F(cha1).buf, _("CV_BAD_NVECTOR: A required vector operation is not implemented."));
                break;
            case 343  :
                strcpy(C2F(cha1).buf, _("CV_NULL_ABSTOL: absolute tolerances = NULL illegal."));
                break;
            case 344  :
                strcpy(C2F(cha1).buf, _("CV_BAD_RELTOL: relative tolerances is reltol < 0 illegal."));
                break;
            case 345  :
                strcpy(C2F(cha1).buf, _("CV_BAD_ABSTOL: abstol has negative component(s) (illegal)."));
                break;
            case 346  :
                strcpy(C2F(cha1).buf, _("CV_NULL_G: User-supplied zero-crossing routine is (NULL) illegal."));
                break;
            case 347  :
                strcpy(C2F(cha1).buf, _("CV_BAD_TOUT: Trouble interpolating. ''tout'' too far back in direction of integration"));
                break;
            case 348  :
                strcpy(C2F(cha1).buf, _("CV_CLOSE_ROOTS: Root found at and very near starting time."));
                break;
            case 349  :
                strcpy(C2F(cha1).buf, _("CV_Derivative_NAN: The Derivatives returned by blocks are NAN."));
                break;
            case 350  :
                strcpy(C2F(cha1).buf, _("CV_Rootfunction_NAN: The Root function returns NAN."));
                break;
            case 401  :
                strcpy(C2F(cha1).buf, _("KIN_MEM_NULL: An error in the memory allocation in KINCreate or KINMalloc."));
                break;
            case 402  :
                strcpy(C2F(cha1).buf, _("KIN_ILL_INPUT: A supplied parameter is invalid (check error message)."));
                break;
            case 403  :
                strcpy(C2F(cha1).buf, _("KIN_NO_MALLOC: Additional system memory has not yet been  allocated for vector storage (forgot to call the  KINMalloc routine)"));
                break;
            case 404  :
                strcpy(C2F(cha1).buf, _("KIN_MEM_FAIL: An error occurred during memory allocation (either insufficient system resources are available or the vector kernel has not yet been initialized "));
                break;
            case 405  :
                ...
                break;
            case 406  :
                strcpy(C2F(cha1).buf, _("KIN_MAXITER_REACHED: The maximum number of nonlinear iterations has been reached "));
                break;
            case 407  :
                ...
                break;
            case 408  :
                strcpy(C2F(cha1).buf, _("KIN_LINESEARCH_BCFAI: The line search algorithm (implemented in KINLineSearch) was unable to satisfy the beta-condition for MXNBCF + 1 nonlinear iterations (not necessarily consecutive), which may indicate the algorithm is making  poor progress "));
                break;
            case 409  :
                strcpy(C2F(cha1).buf, _("KIN_LINSOLV_NO_RECOVERY: The user-supplied routine psolve encountered a recoverable error, but the preconditioner is already current"));
                break;
            case 410  :
                strcpy(C2F(cha1).buf, _("KIN_LINIT_FAIL: The linear solver initialization routine (linit) encountered an error."));
                break;
            case 411  :
                strcpy(C2F(cha1).buf, _("KIN_LSETUP_FAIL: The user-supplied routine pset (used to compute the preconditioner) encountered an unrecoverable error ."));
                break;
            case 412  :
                strcpy(C2F(cha1).buf, _("KIN_LSOLVE_FAIL: Either the user-supplied routine psolve (used to solve the preconditioned linear system) encountered an unrecoverable error, or the linear solver routine (lsolve) encountered an error condition."));
                break;
            case 413  :
                strcpy(C2F(cha1).buf, _("KIN_SYSFUNC_FAIL: Error in the computing function. Please verify your model."));
                break;
            case 414  :
                strcpy(C2F(cha1).buf, _("KIN_FIRST_SYSFUNC_ERR: The system function failed at the first call. Please verify your model. There might be an error in the computing function, for example a function may be called with illegal inputs."));
                break;
            case 415  :
                strcpy(C2F(cha1).buf, _("KIN_REPTD_SYSFUNC_ERR: The system function failed repeatedly. Please verify your model. There might be an error in the computing function, for example a function may be called with illegal inputs"));
                break;
            case 416  :
                strcpy(C2F(cha1).buf, _("KIN_NAN_ERR: The residual function returns NAN. Please verify your model: some functions might be called with illegal inputs."));
                break;
