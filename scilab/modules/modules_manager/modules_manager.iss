...
Source: modules\{#MODULES_MANAGER}\readme.txt; DestDir: {app}\modules\{#MODULES_MANAGER}; Components: {#COMPN_MODULES_MANAGER}
Source: modules\{#MODULES_MANAGER}\license.txt; DestDir: {app}\modules\{#MODULES_MANAGER}; Components: {#COMPN_MODULES_MANAGER}
Source: modules\{#MODULES_MANAGER}\changelog.txt; DestDir: {app}\modules\{#MODULES_MANAGER}; Components: {#COMPN_MODULES_MANAGER}
;
