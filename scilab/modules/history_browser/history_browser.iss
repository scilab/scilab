...
;
Source: modules\{#HISTORY_MANAGER}\sci_gateway\{#HISTORY_BROWSER}_gateway.xml; DestDir: {app}\modules\{#HISTORY_BROWSER}\sci_gateway; Components: {#COMPN_SCILAB} and {#COMPN_JVM_MODULE}
;
