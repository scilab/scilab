...
function [x,y,typ]=SourceP(job,arg1,arg2)
    ...
    case "set" then
        ...
        model=arg1.model;
        while %t do
            [ok,P0,T0,H0,option_temperature,exprs]=scicos_getvalue(_("Fluid SOURCE parameters"),..
            [_("Pressure : P0 (Pa)")
            _("Temperature : T0 (K)")
            _("Specific enthalpy : H0 (J/kg)")
            _("Condition: 1=Fixed temperature | 2=Fixed enthalpy")],..
