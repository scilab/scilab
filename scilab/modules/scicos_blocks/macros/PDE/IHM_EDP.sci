...
function [ok,a_domaine,b_domaine,discr,signe,choix,type_meth,degre,Nbr_maillage,..
  ...
  // Titre
  txt0 = uicontrol(f, "Position",[300 560 100 30],"Style","text","String","PDE block","fontname",...
  ...
  txt1 = uicontrol(f, "Position",[20 600 50 10],"Style","text","String","Domaine","fontsize",10,...
  ...
  txt4 = uicontrol(f, "Position",[20 530 120 10],"Style","text","String","Sp�cification de l''EDP",...
  ...
  txt5 = uicontrol(f, "Position",[20 513 100 10],"Style","text","String","Expression de l''EDP :","fontsize",8,...
  		 "BackgroundColor",[0.7 0.7 0.7]);
  txt_exp = uicontrol(f, "Position",[15 502.5 430 10],"Style","text","String",...
        params_pde.txt_exp,"fontsize",8,"fontname","Times Bold Italic","BackgroundColor",[0.7 0.7 0.7]);
  txt_exp2 = uicontrol(f, "Position",[15 492.5 430 10],"Style","text","String",...
        "","fontsize",8,"fontname","Times Bold Italic","BackgroundColor",[0.7 0.7 0.7]);
  ...
  txt311 = uicontrol(f, "Position",[45 467.5 35 15],"Style","text","String","d2u/dt2","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  frame312= uicontrol(f, "Position",[85 457.5 70 35],"Style","frame","BackgroundColor",[0.8 0.8 0.8]);
  txt22 = uicontrol(f, "Position",[95 476 50 13],"Style","text","String","a1(x)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt23 = uicontrol(f, "Position",[160 476 50 13],"Style","text","String","b1(t)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt321 = uicontrol(f, "Position",[45 427.5 35 15],"Style","text","String","d2u/dx2","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  frame322= uicontrol(f, "Position",[85 417.5 70 35],"Style","frame","BackgroundColor",[0.8 0.8 0.8]);
  txt24 = uicontrol(f, "Position",[95 436 50 13],"Style","text","String","a2(x)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt26 = uicontrol(f, "Position",[160 436 50 13],"Style","text","String","b2(t)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt331 = uicontrol(f, "Position",[45 387.5 30 15],"Style","text","String","du/dt","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  frame332= uicontrol(f, "Position",[85 377.5 70 35],"Style","frame","BackgroundColor",[0.8 0.8 0.8]);
  txt27 = uicontrol(f, "Position",[95 396 50 13],"Style","text","String","a3(x)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt28 = uicontrol(f, "Position",[160 396 50 13],"Style","text","String","b3(t)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt341 = uicontrol(f, "Position",[42.5 347.5 37.5 15],"Style","text","String","d2u/dtdx","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  frame342= uicontrol(f, "Position",[85 337.5 70 35],"Style","frame","BackgroundColor",[0.8 0.8 0.8]);
  txt223 = uicontrol(f, "Position",[95 356 50 13],"Style","text","String","a4(x)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt224 = uicontrol(f, "Position",[160 356 50 13],"Style","text","String","b4(t)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt351 = uicontrol(f, "Position",[270 467.5 30 15],"Style","text","String","du/dx","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  frame352= uicontrol(f, "Position",[305 457.5 70 35],"Style","frame","BackgroundColor",[0.8 0.8 0.8]);
  txt29 = uicontrol(f, "Position",[310 476 50 13],"Style","text","String","a5(x)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt210 = uicontrol(f, "Position",[380 476 50 13],"Style","text","String","b5(t)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt361 = uicontrol(f, "Position",[270 427.5 30 15],"Style","text","String","u","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  frame362= uicontrol(f, "Position",[305 417.5 70 35],"Style","frame","BackgroundColor",[0.8 0.8 0.8]);
  txt211 = uicontrol(f, "Position",[310 436 50 13],"Style","text","String","a6(x)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt222 = uicontrol(f, "Position",[380 436 50 13],"Style","text","String","b6(t)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt371 = uicontrol(f, "Position",[270 387.5 30 15],"Style","text","String","f","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  frame372= uicontrol(f, "Position",[305 377.5 70 35],"Style","frame","BackgroundColor",[0.8 0.8 0.8]);
  txt223 = uicontrol(f, "Position",[310 396 50 13],"Style","text","String","a7(x)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt224 = uicontrol(f, "Position",[380 396 50 13],"Style","text","String","b7(t)","fontsize",8,...
  		 "BackgroundColor",[0.8 0.8 0.8]);
  ...
  txt51 = uicontrol(f, "Position",[170 315 100 15],"Style","text","String","discriminant constant",...
     "fontsize",10,"BackgroundColor",[0.9 0.9 0.9]);		
  ...
  txt53 = uicontrol(f, "Position",[170 295 130 15],"Style","text","String",...
  		 "discriminant non constant :","fontsize",10,"BackgroundColor",[0.9 0.9 0.9]);		
  ...
  txt81 = uicontrol(f, "Position",[25 220 180 10],"Style","text","String","M�thode de discr�tisation spatiale",...
     "fontsize",10,"BackgroundColor",[0.9 0.9 0.9]);
  ...
  rad_automatique = uicontrol(f, "Position", [15 175 13 13],"Style", "checkbox","Value",params_pde.rad_automatique,"BackgroundColor",[1 1 1],...
     "callback", "execlusif_radaut()");
  txt51 = uicontrol(f, "Position",[25 175 70 15],"Style","text","String","Automatique","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);		
  ...
  rad_manuel = uicontrol(f, "Position"  , [15 155 13 13],"Style", "checkbox","Value",params_pde.rad_manuel,"BackgroundColor",[1 1 1],...
     "callback", "execlusif_radman()");
  txt54 = uicontrol(f, "Position",[25 155 45 15],"Style","text","String","Manuel","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);		
  // Type		
  txt82 = uicontrol(f, "Position",[105 200 30 15],"Style","text","String","Type :","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  liste_meth = uicontrol(f, "Position"  , [145 140 80 70],"Style","listbox", "String",methode,"Value",params_pde.methode,...
  		 "BackgroundColor",[1 1 1]); 	
  // Ordonnancement		 
  txt83 = uicontrol(f, "Position",[230 210 100 15],"Style","text","String","Ordonnancement :","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  ...
  editordre3 = uicontrol(f, "Position"  , [270 157.5 15 15],"Style","edit","String",params_pde.ord3,...
  		 "BackgroundColor",[1 1 1]);		
  // Degre		 
  txt84 = uicontrol(f, "Position",[320 200 80 15],"Style","text","String","degr� :","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  editdegre = uicontrol(f, "Position"  , [400 200 15 15],"Style","edit","String",params_pde.degre,...
  		 "BackgroundColor",[1 1 1]);				
  // Pas de maillage		 
  txt6 = uicontrol(f, "Position",[310 180 130 15],"Style","text","String","Nombre de noeuds :","fontsize",10,...
     	 "BackgroundColor",[0.9 0.9 0.9]);
  ...
  txt8 = uicontrol(f, "Position",[25 110 100 10],"Style","text","String","Conditions initiales","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  ...
  txt10 = uicontrol(f, "Position",[25 65 100 10],"Style","text","String","Condition limite en a","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  frame8= uicontrol(f, "Position",[245 5 210 70],"Style","frame","BackgroundColor",[0.9 0.9 0.9]);
  txt11 = uicontrol(f, "Position",[270 65 100 10],"Style","text","String","Condition limite en b","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  ...
  txt12 = uicontrol(f, "Position",[20 10 60 15],"Style","text","String","Expression =","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  editCLa = uicontrol(f, "Position"  , [100 10 90 20],"Style","edit","String",params_pde.CLa_exp,...
  		 "BackgroundColor",[1 1 1]);		
  txt13 = uicontrol(f, "Position",[265 10 60 15],"Style","text","String","Expression =","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
  ...
  txt14 = uicontrol(f, "Position",[485 525 90 15],"Style","text","String","Points de mesure","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);		
  txt141 = uicontrol(f, "Position",[470 500 30 15],"Style","text","String","u(xi) :","fontsize",10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);	
  txt142 = uicontrol(f, "Position",[500 500 160 15],"Style","text","String","les points de mesure",...
       "fontsize",10,"BackgroundColor",[0.9 0.9 0.9]);	
