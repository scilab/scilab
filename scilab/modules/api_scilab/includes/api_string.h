...
StrErr getMatrixOfWideString(int* _piAddress, int* _piRows, int* _piCols, int* _piLength, wchar_t** _pwstStrings);
...
StrErr createMatrixOfWideString(int _iVar, int _iRows, int _iCols, wchar_t** _pwstStrings);
