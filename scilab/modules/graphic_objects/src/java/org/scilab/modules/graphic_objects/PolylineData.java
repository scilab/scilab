...
public class PolylineData {
  ...
  public static void translatePolyline(String uid, double x, double y, double z) {
    PolylineDataJNI.translatePolyline(uid, x, y, z);
  }

  public static void translatePoint(String uid, int index, double x, double y, double z) {
    PolylineDataJNI.translatePoint(uid, index, x, y, z);
  }

  public static void setPointValue(String uid, int index, double x, double y, double z) {
    PolylineDataJNI.setPointValue(uid, index, x, y, z);
  }

  public static void insertPoint(String uid, int index, double x, double y, double z) {
    PolylineDataJNI.insertPoint(uid, index, x, y, z);
  }
