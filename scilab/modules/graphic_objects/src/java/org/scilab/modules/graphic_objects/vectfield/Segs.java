...
public class Segs extends VectField {
     ...
     */
    public UpdateStatus setSegsColor(Integer[] colors) {
        if (colors.length == 1) {
            for (int i = 0; i < arrows.size(); i++) {
     ...
     */
    public UpdateStatus setMarkSizeUnit(MarkSizeUnitType sizeUnit) {
        for (int i = 0; i < arrows.size(); i++) {
