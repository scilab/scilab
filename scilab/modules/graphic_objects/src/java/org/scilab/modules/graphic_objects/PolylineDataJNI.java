...
class PolylineDataJNI {
  ...
  public final static native void translatePolyline(String jarg1, double jarg2, double jarg3, double jarg4);
  public final static native void translatePoint(String jarg1, int jarg2, double jarg3, double jarg4, double jarg5);
  public final static native void setPointValue(String jarg1, int jarg2, double jarg3, double jarg4, double jarg5);
  public final static native void insertPoint(String jarg1, int jarg2, double jarg3, double jarg4, double jarg5);
