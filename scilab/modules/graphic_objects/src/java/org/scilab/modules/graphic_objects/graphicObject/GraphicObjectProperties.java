...
public class GraphicObjectProperties {
    ...
    public static final int __GO_AMBIENTCOLOR__ = 325;
    public static final int __GO_DIFFUSECOLOR__ = 326;
    public static final int __GO_SPECULARCOLOR__ = 327;
    public static final int __GO_COLOR_MATERIAL__ = 328;
    public static final int __GO_MATERIAL_SHININESS__ = 329;
    public static final int __GO_LIGHT__ = 330;
    public static final int __GO_LIGHT_TYPE__ = 331;
    public static final int __GO_DATATIPS__ = 332;
    public static final int __GO_DATATIPS_COUNT__ = 333;
    public static final int __GO_DATATIP_INDEXES__ = 334;
    public static final int __GO_DATA_MODEL_DISPLAY_FUNCTION__ = 335;
    public static final int __GO_DATA_MODEL_DISPLAY_FUNCTION_SIZE__ = 336;
    public static final int __GO_RESIZE__ = 337;
    public static final int __GO_TOOLBAR__ = 338;
    public static final int __GO_TOOLBAR_VISIBLE__ = 339;
    public static final int __GO_MENUBAR__ = 340;
    public static final int __GO_MENUBAR_VISIBLE__ = 341;
    public static final int __GO_INFOBAR_VISIBLE__ = 342;
    public static final int __GO_DOCKABLE__ = 343;
    public static final int __GO_LAYOUT__ = 344;
    public static final int __GO_LAYOUT_SET__ = 345;
    public static final int __GO_UI_TAB__ = 346;
    public static final int __GO_UI_GRIDBAG_GRID__ = 347;
    public static final int __GO_UI_GRIDBAG_WEIGHT__ = 348;
    public static final int __GO_UI_GRIDBAG_FILL__ = 349;
    public static final int __GO_UI_GRIDBAG_ANCHOR__ = 350;
    public static final int __GO_UI_GRIDBAG_PADDING__ = 351;
    public static final int __GO_UI_GRID_GRID__ = 352;
    public static final int __GO_UI_GRID_PADDING__ = 353;
    public static final int __GO_UI_BORDER_POSITION__ = 354;
    public static final int __GO_GRID_OPT_GRID__ = 355;
    public static final int __GO_GRID_OPT_PADDING__ = 356;
    public static final int __GO_BORDER_OPT_PADDING__ = 357;
    public static final int __GO_UI_FRAME_BORDER__ = 358;
    public static final int __GO_UI_FRAME_BORDER_COLOR__ = 359;
    public static final int __GO_UI_FRAME_BORDER_HIGHLIGHT_IN__ = 360;
    public static final int __GO_UI_FRAME_BORDER_HIGHLIGHT_OUT__ = 361;
    public static final int __GO_UI_FRAME_BORDER_IN_BORDER__ = 362;
    public static final int __GO_UI_FRAME_BORDER_JUSTIFICATION__ = 363;
    public static final int __GO_UI_FRAME_BORDER_OUT_BORDER__ = 364;
    public static final int __GO_UI_FRAME_BORDER_ROUNDED__ = 365;
    public static final int __GO_UI_FRAME_BORDER_SHADOW_IN__ = 366;
    public static final int __GO_UI_FRAME_BORDER_SHADOW_OUT__ = 367;
    public static final int __GO_UI_FRAME_BORDER_TITLE__ = 368;
    public static final int __GO_UI_FRAME_BORDER_POSITION__ = 369;
    public static final int __GO_UI_FRAME_BORDER_STYLE__ = 370;
    public static final int __GO_UI_GROUP_NAME__ = 371;
    public static final int __GO_UI_TITLE_POSITION__ = 372;
    public static final int __GO_UI_TITLE_SCROLL__ = 373;
    public static final int __GO_UI_FRAME_BORDER_TYPE__ = 374;
    public static final int __GO_UI_SCROLLABLE__ = 375;
