...
public class GraphicObjectProperties {
    ...
    public static final int __GO_MARKS_COUNT__ = 221;
    public static final int __GO_LINE_WIDTH__ = 222;
    ...
    public static final int __GO_UI_FRAME_SCROLLABLE__ = 266;
    public static final int __GO_UI_IMAGE__ = 267;
    public static final int __GO_UI_LISTBOX__ = 268;
    public static final int __GO_UI_POPUPMENU__ = 269;
    public static final int __GO_UI_PUSHBUTTON__ = 270;
    public static final int __GO_UI_RADIOBUTTON__ = 271;
    public static final int __GO_UI_SLIDER__ = 272;
    public static final int __GO_UI_TABLE__ = 273;
    public static final int __GO_UI_TEXT__ = 274;
    public static final int __GO_UI_LAYER__ = 275;
    public static final int __GO_UI_BACKGROUNDCOLOR__ = 276;
    public static final int __GO_UI_ENABLE__ = 277;
    public static final int __GO_UI_FONTANGLE__ = 278;
    public static final int __GO_UI_FONTNAME__ = 279;
    public static final int __GO_UI_FONTSIZE__ = 280;
    public static final int __GO_UI_FONTUNITS__ = 281;
    public static final int __GO_UI_FONTWEIGHT__ = 282;
    public static final int __GO_UI_FOREGROUNDCOLOR__ = 283;
    public static final int __GO_UI_HORIZONTALALIGNMENT__ = 284;
    public static final int __GO_UI_LISTBOXTOP__ = 285;
    public static final int __GO_UI_LISTBOXTOP_SIZE__ = 286;
    public static final int __GO_UI_MAX__ = 287;
    public static final int __GO_UI_MIN__ = 288;
    public static final int __GO_UI_RELIEF__ = 289;
    public static final int __GO_UI_STRING__ = 290;
    public static final int __GO_UI_STRING_SIZE__ = 291;
    public static final int __GO_UI_STRING_COLNB__ = 292;
    public static final int __GO_UI_TOOLTIPSTRING__ = 293;
    public static final int __GO_UI_TOOLTIPSTRING_SIZE__ = 294;
    public static final int __GO_UI_SLIDERSTEP__ = 295;
    public static final int __GO_UI_UNITS__ = 296;
    public static final int __GO_UI_VALUE__ = 297;
    public static final int __GO_UI_VALUE_SIZE__ = 298;
    public static final int __GO_UI_VERTICALALIGNMENT__ = 299;
    public static final int __GO_UIPARENTMENU__ = 300;
    public static final int __GO_UICHILDMENU__ = 301;
    public static final int __GO_UICHECKEDMENU__ = 302;
    public static final int __GO_UI_CHECKED__ = 303;
    public static final int __GO_UI_LABEL__ = 304;
    public static final int __GO_UI_MNEMONIC__ = 305;
    public static final int __GO_UI_ACCELERATOR__ = 306;
    public static final int __GO_UI_SEPARATOR__ = 307;
    public static final int __GO_UI_ICON__ = 308;
    public static final int __GO_CONSOLE__ = 309;
    public static final int __GO_SHOWHIDDENHANDLES__ = 310;
    public static final int __GO_USEDEPRECATEDLF__ = 311;
    public static final int __GO_WAITBAR__ = 312;
    public static final int __GO_PROGRESSIONBAR__ = 313;
    public static final int __GO_UI_MESSAGE__ = 314;
    public static final int __GO_UI_MESSAGE_SIZE__ = 315;
    public static final int __GO_DATATIP__ = 316;
    public static final int __GO_DATATIP_DATA__ = 317;
    public static final int __GO_DATATIP_ORIENTATION__ = 318;
    public static final int __GO_DATATIP_3COMPONENT__ = 319;
    public static final int __GO_DATATIP_AUTOORIENTATION__ = 320;
    public static final int __GO_DATATIP_INTERP_MODE__ = 321;
    public static final int __GO_DATATIP_DISPLAY_FNC__ = 322;
    public static final int __GO_DATATIP_BOX_MODE__ = 323;
    public static final int __GO_DATATIP_LABEL_MODE__ = 324;
    public static final int __GO_DATATIP_MARK__ = 325;
    public static final int __GO_AMBIENTCOLOR__ = 326;
    public static final int __GO_DIFFUSECOLOR__ = 327;
    public static final int __GO_SPECULARCOLOR__ = 328;
    public static final int __GO_COLOR_MATERIAL__ = 329;
    public static final int __GO_MATERIAL_SHININESS__ = 330;
    public static final int __GO_LIGHT__ = 331;
    public static final int __GO_LIGHT_TYPE__ = 332;
    public static final int __GO_DATATIPS__ = 333;
    public static final int __GO_DATATIPS_COUNT__ = 334;
    public static final int __GO_DATATIP_INDEXES__ = 335;
    public static final int __GO_DATA_MODEL_DISPLAY_FUNCTION__ = 336;
    public static final int __GO_DATA_MODEL_DISPLAY_FUNCTION_SIZE__ = 337;
    public static final int __GO_RESIZE__ = 338;
    public static final int __GO_TOOLBAR__ = 339;
    public static final int __GO_TOOLBAR_VISIBLE__ = 340;
    public static final int __GO_MENUBAR__ = 341;
    public static final int __GO_MENUBAR_VISIBLE__ = 342;
    public static final int __GO_INFOBAR_VISIBLE__ = 343;
    public static final int __GO_DOCKABLE__ = 344;
    public static final int __GO_LAYOUT__ = 345;
    public static final int __GO_LAYOUT_SET__ = 346;
    public static final int __GO_UI_TAB__ = 347;
    public static final int __GO_UI_GRIDBAG_GRID__ = 348;
    public static final int __GO_UI_GRIDBAG_WEIGHT__ = 349;
    public static final int __GO_UI_GRIDBAG_FILL__ = 350;
    public static final int __GO_UI_GRIDBAG_ANCHOR__ = 351;
    public static final int __GO_UI_GRIDBAG_PADDING__ = 352;
    public static final int __GO_UI_GRID_GRID__ = 353;
    public static final int __GO_UI_GRID_PADDING__ = 354;
    public static final int __GO_UI_BORDER_POSITION__ = 355;
    public static final int __GO_GRID_OPT_GRID__ = 356;
    public static final int __GO_GRID_OPT_PADDING__ = 357;
    public static final int __GO_BORDER_OPT_PADDING__ = 358;
    public static final int __GO_UI_FRAME_BORDER__ = 359;
    public static final int __GO_UI_FRAME_BORDER_COLOR__ = 360;
    public static final int __GO_UI_FRAME_BORDER_HIGHLIGHT_IN__ = 361;
    public static final int __GO_UI_FRAME_BORDER_HIGHLIGHT_OUT__ = 362;
    public static final int __GO_UI_FRAME_BORDER_IN_BORDER__ = 363;
    public static final int __GO_UI_FRAME_BORDER_JUSTIFICATION__ = 364;
    public static final int __GO_UI_FRAME_BORDER_OUT_BORDER__ = 365;
    public static final int __GO_UI_FRAME_BORDER_ROUNDED__ = 366;
    public static final int __GO_UI_FRAME_BORDER_SHADOW_IN__ = 367;
    public static final int __GO_UI_FRAME_BORDER_SHADOW_OUT__ = 368;
    public static final int __GO_UI_FRAME_BORDER_TITLE__ = 369;
    public static final int __GO_UI_FRAME_BORDER_POSITION__ = 370;
    public static final int __GO_UI_FRAME_BORDER_STYLE__ = 371;
    public static final int __GO_UI_GROUP_NAME__ = 372;
    public static final int __GO_UI_TITLE_POSITION__ = 373;
    public static final int __GO_UI_TITLE_SCROLL__ = 374;
    public static final int __GO_UI_FRAME_BORDER_TYPE__ = 375;
    public static final int __GO_UI_SCROLLABLE__ = 376;
