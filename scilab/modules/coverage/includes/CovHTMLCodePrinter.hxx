...
public:
    ...
    CovHTMLCodePrinter(std::ostringstream & _out, std::map<MacroLoc, CoverResult> & _results) : out(_out), indentLevel(0), counter(0), lineCount(0), isNewLine(true), current(nullptr), last(nullptr), results(_results), fnId(0)
    {
    }
