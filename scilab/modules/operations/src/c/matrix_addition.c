...
int iAddRealScalarToRealMatrix()
{
	return 0;
}

int iAddRealScalarToComplexMatrix()
{
	return 0;
}

int iAddComplexScalarToRealMatrix()
{
	return 0;
}

int iAddComplexScalarToComplexMatrix()
{
	return 0;
}

int iAddRealMatrixToRealMatrix()
{
	return 0;
}

int iAddRealMatrixToComplexMatrix()
{
	return 0;
}

int iAddComplexMatrixToComplexMatrix()
{
	return 0;
}

/*Poly + Double*/
int iAddRealScalarToRealPoly()
{
	return 0;
}

int iAddRealScalarToComplexPoly()
{
	return 0;
}

int iAddComplexScalarToRealPoly()
{
	return 0;
}

int iAddComplexScalarToComplexPoly()
{
	return 0;
}

int iAddRealMatrixToRealPoly()
{
	return 0;
}

int iAddRealMatrixToComplexPoly()
{
	return 0;
}

int iAddComplexMatrixToRealPoly()
{
	return 0;
}

int iAddComplexMatrixToComplexPoly()
{
	return 0;
}
