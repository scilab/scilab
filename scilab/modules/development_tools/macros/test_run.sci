...
//        "lines(0);" ;                                                           ...
    ...
    if getos() == 'Windows' then
        ...
        test_cmd = "( """ + SCI_BIN + "\bin\YaSp.exe" + """" + " " + mode_arg + " " + language_arg + " -nb -e """ + execCmd + """ > """ + tmp_res + """ ) 2> """ + tmp_err + """";
    else
        //test_cmd = "( " + language_arg + " " + SCI_BIN + "/bin/scilab " + mode_arg + " -nb -f " + tmp_tst + " > " + tmp_res + " ) 2> " + tmp_err;
        test_cmd = "( " + language_arg + " " + SCI_BIN + "/bin/scilab " + mode_arg + " -nb -e """ + execCmd + """ > " + tmp_res + " ) 2> " + tmp_err;
    end
