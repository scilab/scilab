...
fr_FR.MsgBoxJREReinstall = Relancer l'installeur de Scilab aprés l'installation du JRE.
fr_FR.MsgBoxSSERequired = Les instructions CPU SSE2 sont requises pour faire fonctionner.
fr_FR.MsgBoxX64Ready = Pour de meilleurs performances, il serait mieux d'utiliser la version 64 bits de Scilab sur ce systeme d'exploitation.

fr_FR.MsgBoxJavaDetection1 =Java n'est pas installé correctement sur cet ordinateur.
fr_FR.MsgBoxJavaDetection2 =Veuillez selectionner & installer Java Runtime :
fr_FR.MsgBoxWebOpen =Can not open web page.
...
fr_FR.MsgBoxFftw4 =Impossible d'acceder à cette page web.
fr_FR.MsgBoxWinVer =Nécéssite Windows 2000 ou plus.
fr_FR.MsgBoxScicosRequired1 =Vous avez choisi d'installer le module Xcos mais vous n'avez pas selectionné le module Scicos.
fr_FR.MsgBoxScicosRequired2 =Veuillez egalement installer le module Scicos.

;
fr_FR.ButtonAboutModules =&A propos des modules ...
;
fr_FR.DescriptionEquDif =Module sur les Equations Differentielles
fr_FR.DescriptionInterpolation =Module sur l'Interpolation
fr_FR.DescriptionPolynomials =Module Polynomes
fr_FR.DescriptionSymbolic =Module Calculs Symboliques
fr_FR.DescriptionStats =Module de Statistiques
fr_FR.DescriptionSparse =Module sur les Matrices Creuse
fr_FR.DescriptionLinAlg =Module d'Algebre Lineaire
fr_FR.DescriptionSigProc =Module de Traitement du Signal
fr_FR.DescriptionCacsd =Module C.A.C.S.D
fr_FR.DescriptionGraphics =Module Graphique
fr_FR.DescriptionOptim =Module d'Optimisation
fr_FR.DescriptionMetanet =Metanet
fr_FR.DescriptionScicos =Scicos
fr_FR.DescriptionArnoldi =Boite à outils ARnoldi PACKage
fr_FR.DescriptionUmfpack =UMFPACK pour Scilab
...
fr_FR.DescriptionRefFftwLibrary = Librairie FFTW3 de reference
fr_FR.DescriptionParametersTlbx =Boite à outils Paramètres
fr_FR.DescriptionGeneticTlbx =Boite à outils Algorithmes Génétiques
fr_FR.DescriptionSimulAnnealingTlbx =Boite à outils Recuit Simulé
fr_FR.DescriptionDevTools =Outils pour le Developpement
fr_FR.DescriptionTests =Tests pour Scilab
fr_FR.DescriptionTlbxSkeleton =Un modele de boite à outils (pour étendre scilab)
fr_FR.DescriptionComConnector = COM connecteur (Serveur)
fr_FR.DescriptionSciNotes = SciNotes : Editeur de Texte pour Scilab
...
;
fr_FR.RegKeyRunWith =Executer avec
;
...
;
fr_FR.DescriptionLaunchScilab =Executer Scilab
;
fr_FR.DescriptionCreateDesktopIcon =Creer un icone sur le bureau
;
fr_FR.DescriptionQuickLaunch =Creer un raccourci dans la barre d'execution rapide
;
...
fr_FR.DescriptionRefBlasLibrary =Libraires Blas, Lapack de reference pour Scilab
fr_FR.DescriptionMKLLibrary =Telecharger la librairie Intel Math Kernel Library pour Scilab
;
fr_FR.DownloadMKLLabel =Telechargement des fichiers Intel Math Kernel Library pour Scilab
fr_FR.DownloadMKLDescription =Merci de patienter durant le telechargement de fichiers.
;
