...
#else
                if (IsWow64()) return OS_WIN32_WINDOWS_EIGHT_64;
                else return OS_WIN32_WINDOWS_EIGHT;
#endif
            }
            else
            {
...
#else
                if (IsWow64()) return OS_WIN32_WINDOWS_EIGHT_SERVER_64;
                else return  OS_WIN32_WINDOWS_EIGHT_SERVER;
#endif
            }
        }
