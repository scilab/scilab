...
/* BOOLEAN:VOID (./gtkmarshalers.list:36) */
...
/* BOOLEAN:BOOLEAN (./gtkmarshalers.list:37) */
...
/* BOOLEAN:NONE (./gtkmarshalers.list:38) */
#define _gtk_marshal_BOOLEAN__NONE	_gtk_marshal_BOOLEAN__VOID

/* BOOLEAN:BOOLEAN,BOOLEAN,BOOLEAN (./gtkmarshalers.list:39) */
...
/* ENUM:ENUM (./gtkmarshalers.list:40) */
...
/* INT:POINTER (./gtkmarshalers.list:41) */
...
/* NONE:BOOLEAN (./gtkmarshalers.list:42) */
...
/* NONE:INT,INT (./gtkmarshalers.list:46) */
...
/* STRING:DOUBLE (./gtkmarshalers.list:49) */
...
/* VOID:DOUBLE (./gtkmarshalers.list:50) */
#define _gtk_marshal_VOID__DOUBLE	g_cclosure_marshal_VOID__DOUBLE

/* VOID:BOOLEAN (./gtkmarshalers.list:51) */

/* VOID:BOOLEAN,BOOLEAN,BOOLEAN (./gtkmarshalers.list:52) */
...
/* VOID:BOXED (./gtkmarshalers.list:53) */
#define _gtk_marshal_VOID__BOXED	g_cclosure_marshal_VOID__BOXED

/* VOID:BOXED,BOXED (./gtkmarshalers.list:54) */
...
/* VOID:BOXED,BOXED,POINTER (./gtkmarshalers.list:55) */
...
/* VOID:BOXED,OBJECT (./gtkmarshalers.list:56) */
...
/* VOID:BOXED,STRING,INT (./gtkmarshalers.list:57) */
...
/* VOID:BOXED,UINT (./gtkmarshalers.list:58) */
...
/* VOID:BOXED,UINT,FLAGS (./gtkmarshalers.list:59) */
...
/* VOID:BOXED,UINT,UINT (./gtkmarshalers.list:60) */
...
/* VOID:ENUM (./gtkmarshalers.list:61) */

/* VOID:ENUM,BOOLEAN (./gtkmarshalers.list:62) */
...
/* VOID:ENUM,ENUM (./gtkmarshalers.list:63) */
...
/* VOID:ENUM,FLOAT (./gtkmarshalers.list:64) */
...
/* VOID:ENUM,FLOAT,BOOLEAN (./gtkmarshalers.list:65) */
...
/* VOID:ENUM,INT (./gtkmarshalers.list:66) */
...
/* VOID:ENUM,INT,BOOLEAN (./gtkmarshalers.list:67) */
...
/* VOID:INT (./gtkmarshalers.list:68) */

/* VOID:INT,INT (./gtkmarshalers.list:69) */

/* VOID:INT,INT,BOXED (./gtkmarshalers.list:70) */
...
/* VOID:INT,INT,INT (./gtkmarshalers.list:71) */
...
/* VOID:OBJECT (./gtkmarshalers.list:72) */
#define _gtk_marshal_VOID__OBJECT	g_cclosure_marshal_VOID__OBJECT

/* VOID:OBJECT,BOOLEAN (./gtkmarshalers.list:73) */
...
/* VOID:OBJECT,BOXED,BOXED (./gtkmarshalers.list:74) */
...
/* VOID:OBJECT,BOXED,UINT,UINT (./gtkmarshalers.list:75) */
...
/* VOID:OBJECT,INT,INT (./gtkmarshalers.list:76) */
...
/* VOID:OBJECT,INT,INT,BOXED,UINT,UINT (./gtkmarshalers.list:77) */
...
/* VOID:OBJECT,OBJECT (./gtkmarshalers.list:78) */
...
/* VOID:OBJECT,STRING,STRING (./gtkmarshalers.list:79) */
...
/* VOID:OBJECT,UINT (./gtkmarshalers.list:80) */
...
/* VOID:OBJECT,UINT,FLAGS (./gtkmarshalers.list:81) */
...
/* VOID:POINTER (./gtkmarshalers.list:82) */
#define _gtk_marshal_VOID__POINTER	g_cclosure_marshal_VOID__POINTER

/* VOID:POINTER,INT (./gtkmarshalers.list:83) */
...
/* VOID:POINTER,POINTER,POINTER (./gtkmarshalers.list:84) */
...
/* VOID:POINTER,UINT (./gtkmarshalers.list:85) */
...
/* VOID:STRING (./gtkmarshalers.list:86) */
#define _gtk_marshal_VOID__STRING	g_cclosure_marshal_VOID__STRING

/* VOID:STRING,STRING (./gtkmarshalers.list:87) */
...
/* VOID:STRING,INT,POINTER (./gtkmarshalers.list:88) */

/* VOID:UINT,FLAGS,BOXED (./gtkmarshalers.list:89) */
...
/* VOID:UINT,UINT (./gtkmarshalers.list:90) */
...
/* VOID:UINT,STRING (./gtkmarshalers.list:91) */
...
/* VOID:UINT,BOXED,UINT,FLAGS,FLAGS (./gtkmarshalers.list:92) */
...
/* VOID:UINT,OBJECT,UINT,FLAGS,FLAGS (./gtkmarshalers.list:93) */
...
/* VOID:VOID (./gtkmarshalers.list:94) */
