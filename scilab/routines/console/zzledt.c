...
extern struct hist * SearchForwardInHistory(char *line); 
extern void AddHistory (char *line);
extern struct hist *history;
extern struct hist *cur_entry;
extern struct hist *research_knot_last;
 ...
 **********************************************************************/
extern void
C2F(zzledt)(buffer, buf_size, len_line, eof, menusflag, modex, dummy1)
/**********************************************************************/
char *buffer;
int *buf_size;
int *len_line;
 ...
 **********************************************************************/
static void
move_right(char *source, int max_chars)
/**********************************************************************/
{
   char *p;
