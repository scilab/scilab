...
static TabF Tab[]={ 
  {iHoward, "hhoward"},   {iSemi_Howard, "hsemihoward"}, {iKarp, "hkarp"}, {isparse2full, "Max_Full"}, {iin_span, "hin_span"}, {iweakbasis, "hweakbasis"},  {iinclude_span, "hinclude_span"}, {iproduct, "hproduct"}, {irowbasis, "hrowbasis"}, {isolve2, "hsolve"}, {isolve3, "hsolve3"}, {iweakbasis2, "hweakbasis2"}, {istar, "hstar"}, {iplus, "hplus"}, {iFordBellman, "hFordBellman"}
};
