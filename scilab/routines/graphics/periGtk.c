...
static GdkPoint *gtk_get_xpoints();
...
static int XgcAllocColors(xgc,m)
     struct BCG *xgc;
     int m;
{
...
static void XgcFreeColors(xgc)
     struct BCG *xgc;
{
  FREE(xgc->Red);   FREE(xgc->Green);  FREE(xgc->Blue);
  xgc->Red = xgc->Green = xgc->Blue;
}
...
static void xset_pixmapclear(v1, v2, v3, v4)
     integer *v1, *v2, *v3, *v4;
{
  PixmapClear(0,0,ScilabXgc->CWindowWidth,ScilabXgc->CWindowHeight);
}

static void xset_show(v1, v2, v3, v4)
     integer *v1;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void PixmapClear(x,y,w,h)
     int x,y,w,h;
{
  gdk_gc_set_background(ScilabXgc->stdgc, &ScilabXgc->gcol_bg);
     ...
     char *str;
{
  ...
  */
  ...
  /* XXXXX : a finnir doit surveiller les menus connect signal */
  /* timer = gtk_timeout_add (100, (GtkFunction) timeout_test, ScilabXgc->drawing); */
...
static void RectangleClear(x,y,w,h,clipflag,F)
     int x,y,w,h,clipflag; 
     r_c F;
{
...
static void xget_windowpos(verbose, x, narg,dummy)
     integer *verbose;
     integer *x;
     integer *narg;
     double *dummy;
...
static void xset_windowpos(x, y, v3, v4)
     integer *x;
     integer *y;
     integer *v3;
     integer *v4;
...
static void xget_windowdim(verbose, x, narg,dummy)
     integer *verbose;
     integer *x;
     integer *narg;
     double *dummy;
...
static void xset_windowdim(x, y, v3, v4)
     integer *x;
     integer *y;
     integer *v3;
     integer *v4;
...
static void xget_popupdim(verbose, x, narg,dummy)
     integer *verbose;
     integer *x;
     integer *narg;
     double *dummy;
...
static void xset_popupdim(x, y, v3, v4)
     integer *x;
     integer *y;
     integer *v3;
     integer *v4;
...
static void xget_viewport(verbose, x, narg,dummy)
     integer *verbose;
     integer *x;
     integer *narg;
     double *dummy;
...
static void xset_viewport(x, y, v3, v4)
     integer *x;
     integer *y;
     integer *v3;
     integer *v4;
...
static void xset_curwin(intnum, v2, v3, v4)
     integer *intnum;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_curwin(verbose, intnum, narg,dummy)
     integer *verbose;
     integer *intnum;
     integer *narg;
     double *dummy;
...
static void xset_unclip(v1, v2, v3, v4)
     integer *v1;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_clip(verbose, x, narg,dummy)
     integer *verbose;
     integer *x;
     integer *narg;
     double *dummy;
...
static void xset_absourel(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_absourel(verbose, num, narg,dummy)
     integer *verbose;
     integer *num;
     integer *narg;
     double *dummy;
...
static void xset_alufunction1(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_alufunction(verbose, value, narg,dummy)
     integer *verbose;
     integer *value;
     integer *narg;
     double *dummy;
...
static void xset_thickness(value, v2, v3, v4)
     integer *value;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_thickness(verbose, value, narg,dummy)
     integer *verbose;
     integer *value;
     integer *narg;
     double *dummy;
...
*/
static void xset_pattern(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_pattern(verbose, num, narg,dummy)
     integer *verbose;
     integer *num;
     integer *narg;
     double *dummy;
...
static void xget_last(verbose, num, narg,dummy)
     integer *verbose;
     integer *num;
     integer *narg;
     double *dummy;
...
static void xset_dash(value, v2, v3, v4)
     integer *value;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xset_dash_or_color(value, v2, v3, v4)
     integer *value;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xset_dash_and_color(value, v2, v3, v4)
     integer *value;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xset_line_style(value, v2, v3, v4)
     integer *value;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xset_dashstyle(value, xx, n)
     integer *value;
     integer *xx;
     integer *n;
{
...
static void xget_dash_or_color(verbose, value, narg,dummy)
     integer *verbose;
     integer *value;
     integer *narg;
     double *dummy;
...
static void xget_dash(verbose, value, narg,dummy)
     integer *verbose;
     integer *value;
     integer *narg;
     double *dummy;
...
static void xget_dash_and_color(verbose, value, narg,dummy)
     integer *verbose;
     integer *value;
     integer *narg;
     double *dummy;
...
static void xset_usecolor(num, v1, v2, v3)
     integer *num;
     integer *v1;
     integer *v2;
     integer *v3;
...
static void xget_usecolor(verbose, num, narg,dummy)
     integer *verbose;
     integer *num;
     integer *narg;
     double *dummy;
...
static void xset_pixmapOn(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_pixmapOn(verbose, value, narg,dummy)
     integer *verbose;
     integer *value;
     integer *narg;
     double *dummy;
...
static void xset_wresize(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_wresize(verbose, value, narg,dummy)
     integer *verbose;
     integer *value;
     integer *narg;
     double *dummy;
...
static void xget_colormap(verbose,num,narg,val)
     integer *verbose;
     integer *num;
     integer *narg;
     double *val;
...
static void xset_background(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_background(verbose, num, narg,dummy)
     integer *verbose;
     integer *num;
     integer *narg;
     double *dummy;
...
static void xset_foreground(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_foreground(verbose, num, narg,dummy)
     integer *verbose;
     integer *num;
     integer *narg;
     double *dummy;
...
static void xset_hidden3d(num, v2, v3, v4)
     integer *num;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_hidden3d(verbose, num, narg,dummy)
     integer *verbose;
     integer *num;
     integer *narg;
     double *dummy;
...
static void xset_empty(verbose, v2, v3, v4)
     integer *verbose;
     integer *v2;
     integer *v3;
     integer *v4;
...
static void xget_empty(verbose, v2, v3,dummy)
     integer *verbose;
     integer *v2;
     integer *v3;
     double *dummy;
...
void C2F(drawpolyline)(str, n, vx, vy, closeflag, v6, v7, dv1, dv2, dv3, dv4)
     char *str;
     integer *n, *vx, *vy, *closeflag, *v6, *v7;
     double *dv1, *dv2, *dv3, *dv4;
{ 
  integer n1;
...
static struct BCG *AddNewWindowToList()
{
  return( AddNewWindow(&The_List));
}

static struct BCG *AddNewWindow(listptr)
     WindowList **listptr;
{ 
...
GtkWidget *GetWindowNumber(wincount)
     int wincount;
{
  struct BCG *bcg;
...
static struct BCG *GetWinXgc(listptr, i)
     WindowList *listptr;
     integer i;
{
  if (listptr == (WindowList  *) NULL)
...
GtkWidget *GetBGWindowNumber(wincount)
     int wincount;
{
  struct BCG *bcg;
  bcg = GetWindowXgcNumber(wincount);
...
static void xset_font(fontid, fontsize, v3, v4)
     integer *fontid;
     integer *fontsize;
     integer *v3;
     integer *v4;
...
static void  xget_font(verbose, font, nargs,dummy)
     integer *verbose;
     integer *font;
     integer *nargs;
     double *dummy;
...
static void xset_mark(number, size, v3, v4)
     integer *number;
     integer *size;
     integer *v3;
     integer *v4;
...
static void xget_mark(verbose, symb, narg,dummy)
     integer *verbose;
     integer *symb;
     integer *narg;
     double *dummy;
...
static GdkPoint *gtk_get_xpoints() { return(gtk_points); }

static int gtk_store_points(n, vx, vy, onemore)
     integer n,*vx, *vy, onemore;
{ 
...
static int GTK_Open(struct BCG *dd, char *dsp, double w, double h)
{
  ...
  dd->wgc = NULL;
  dd->gcursor = NULL;
  /* initialise Gtk : performed in main  */
  /* gtk_init (&argc, &argv); */
  /* initialise colour */
  gdk_rgb_init();
  ...
  gtk_widget_set_usize(scrolled_window,300,200);
