...
static int inttree2 _PARAMS((char *fname, unsigned long fname_len));
static int inttree3 _PARAMS((char *fname, unsigned long fname_len));
static int inttree4 _PARAMS((char *fname, unsigned long fname_len));
