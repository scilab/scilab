function [out]=Fooo(t,Y,Yprim)
    ...
    Yprim(5)-Y(11);
    Yprim(6)-Y(12);
    M*Yprim(7)+m1*Yprim(7)+m1*Yprim(10)*sin(Y(3))+2.0*m1*Y(10)*cos(Y(3))*Y(9)-m1*Y(4)*sin(Y(3))*Y(9)**2+m1*Y(4)*cos(Y(3))*Yprim(9)+m2*Yprim(7)+m2*Yprim(10)*sin(Y(3))+2.0*m2*Y(10)*cos(Y(3))*Y(9)-m2*Y(4)*sin(Y(3))*Y(9)**2+m2*Y(4)*cos(Y(3))*Yprim(9)+m2*Yprim(12)*sin(Y(5))+2.0*m2*Y(12)*cos(Y(5))*Y(11)-m2*Y(6)*sin(Y(5))*Y(11)**2+m2*Y(6)*cos(Y(5))*Yprim(11)-2.0*Y(13)*Y(1)+0.11D1*Y(13)*sin(0.33D1*Y(1))+k*Y(7);
    M*Yprim(8)+m1*Yprim(8)-m1*Yprim(10)*cos(Y(3))+2*m1*Y(10)*sin(Y(3))*Y(9)+m1*Y(4)*cos(Y(3))*Y(9)**2+m1*Y(4)*sin(Y(3))*Yprim(9)+m2*Yprim(8)-m2*Yprim(10)*cos(Y(3))+2*m2*Y(10)*sin(Y(3))*Y(9)+m2*Y(4)*cos(Y(3))*Y(9)**2+m2*Y(4)*sin(Y(3))*Yprim(9)-m2*Yprim(12)*cos(Y(5))+2*m2*Y(12)*sin(Y(5))*Y(11)+m2*Y(6)*cos(Y(5))*Y(11)**2+m2*Y(6)*sin(Y(5))*Yprim(11)+M*g+m1*g+m2*g+Y(13)+k*Y(8);
    Y(4)*(m1*g*sin(Y(3))+m2*g*sin(Y(3))+m1*cos(Y(3))*Yprim(7)+m1*sin(Y(3))*Yprim(8)+m2*cos(Y(3))*Yprim(7)+m2*sin(Y(3))*Yprim(8)+m2*cos(Y(3))*Yprim(12)*sin(Y(5))-m2*sin(Y(3))*Yprim(12)*cos(Y(5))+2*m2*cos(Y(3))*Y(12)*cos(Y(5))*Y(11)-m2*cos(Y(3))*Y(6)*sin(Y(5))*Y(11)**2+m2*cos(Y(3))*Y(6)*cos(Y(5))*Yprim(11)+2*m2*sin(Y(3))*Y(12)*sin(Y(5))*Y(11)+m2*sin(Y(3))*Y(6)*cos(Y(5))*Y(11)**2+m2*sin(Y(3))*Y(6)*sin(Y(5))*Yprim(11)+m1*Y(4)*Yprim(9)+2*m1*Y(9)*Y(10)+m2*Y(4)*Yprim(9)+2*m2*Y(9)*Y(10));
    -m2*g*cos(Y(3))+m1*Yprim(10)-m2*cos(Y(3))*Yprim(8)-m1*g*cos(Y(3))+m1*sin(Y(3))*Yprim(7)-m1*cos(Y(3))*Yprim(8)+m2*sin(Y(3))*Yprim(12)*sin(Y(5))+m2*cos(Y(3))*Yprim(12)*cos(Y(5))+m2*sin(Y(3))*Yprim(7)+k1*Y(4)-k1*l1bar+2*m2*sin(Y(3))*Y(12)*cos(Y(5))*Y(11)-m2*sin(Y(3))*Y(6)*sin(Y(5))*Y(11)**2+m2*sin(Y(3))*Y(6)*cos(Y(5))*Yprim(11)-2*m2*cos(Y(3))*Y(12)*sin(Y(5))*Y(11)-m2*cos(Y(3))*Y(6)*cos(Y(5))*Y(11)**2-m2*cos(Y(3))*Y(6)*sin(Y(5))*Yprim(11)-m1*Y(4)*Y(9)**2-m2*Y(4)*Y(9)**2+m2*Yprim(10);
    m2*Y(6)*(-cos(Y(5))*Y(4)*sin(Y(3))*Y(9)**2+cos(Y(5))*Y(4)*cos(Y(3))*Yprim(9)+2*cos(Y(5))*Y(10)*cos(Y(3))*Y(9)-sin(Y(5))*Yprim(10)*cos(Y(3))+Y(6)*Yprim(11)+g*sin(Y(5))+cos(Y(5))*Yprim(10)*sin(Y(3))+2*Y(11)*Y(12)+cos(Y(5))*Yprim(7)+sin(Y(5))*Yprim(8)+2*sin(Y(5))*Y(10)*sin(Y(3))*Y(9)+sin(Y(5))*Y(4)*cos(Y(3))*Y(9)**2+sin(Y(5))*Y(4)*sin(Y(3))*Yprim(9));
    -m2*g*cos(Y(5))+m2*Yprim(12)-m2*cos(Y(5))*Yprim(8)+m2*sin(Y(5))*Yprim(10)*sin(Y(3))+m2*cos(Y(5))*Yprim(10)*cos(Y(3))-m2*Y(6)*Y(11)**2+2*m2*sin(Y(5))*Y(10)*cos(Y(3))*Y(9)+m2*sin(Y(5))*Yprim(7)-m2*sin(Y(5))*Y(4)*sin(Y(3))*Y(9)**2+m2*sin(Y(5))*Y(4)*cos(Y(3))*Yprim(9)-2*m2*cos(Y(5))*Y(10)*sin(Y(3))*Y(9)-m2*cos(Y(5))*Y(4)*cos(Y(3))*Y(9)**2-m2*cos(Y(5))*Y(4)*sin(Y(3))*Yprim(9)+k2*Y(6)-k2*l2bar;
