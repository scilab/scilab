//----------------------------------------------------------------------------
// com-ordre-2-avec-2-PFC-ordre-1
...
// pour perturbation de gain X 1.5 / voir ligne 73
k1=K1*1.5;
k2=K2*1.5;
...
for ii=2:1:tf;// recherche du h optimal max
    ...
    if (ii > T ) & ( dev(ii) < dev(ii-1) ) & ( gl == 1 ) then
        hh=ii;
        gl=0;
    end
end // fin du for
