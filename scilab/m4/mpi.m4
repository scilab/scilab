dnl TODO : rewrite this file (licence unsure)
...
dnl the default action will define WITH_MPI.
dnl
dnl @version $Id: acx_mpi.m4,v 1.2 2002/10/24 05:11:22 stevenj Exp $
...
if test x = x"$MPILIBS"; then
        ...
        AC_DEFINE(WITH_MPI,1,[Define if you have the MPI library.])
fi
])dnl ACX_MPI
