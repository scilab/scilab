...
AC_ARG_WITH(docbook,
	...
	for dir in $withval /usr/share/sgml/docbook/stylesheet/xsl/nwalsh /usr/share/docbook2X/xslt/man/ /usr/share/xml/docbook/stylesheet/nwalsh/ /sw/share/xml/xsl/docbook-xsl /usr/share/xml/docbook/xsl-stylesheets-*/ /usr/share/sgml/docbook/xsl-stylesheets--*/ /usr/share/sgml/docbook/xsl-stylesheets-*/; do
		if test -d "$dir"; then
			DOCBOOK_ROOT=$dir
        fi
	done
