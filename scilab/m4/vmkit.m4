...
if test -n "$with_vmkit_package"; then
   ...
   LLVM_INCLUDE_DIR="/usr/include/llvm-3.3/"
   LLVM_LIB_DIR="/usr/lib/llvm-3.3/lib/"
   VMKIT_INCLUDE_DIR="/usr/include/vmkit/"
   VMKIT_BIN_DIR="/usr/bin/"
   VMKIT_CPPFLAGS="-I$LLVM_INCLUDE_DIR/ -I$VMKIT_INCLUDE_DIR/ -I$VMKIT_INCLUDE_DIR/MMTk/ -D_DEBUG -D_GNU_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS -O3 -fomit-frame-pointer -fvisibility-inlines-hidden -fPIC -Woverloaded-virtual -Wcast-qual"
# TODO: use llvm-config-X.Y
   VMKIT_LDFLAGS="-L$LLVM_LIB_DIR/ -lLLVMBitReader -lLLVMipo -lLLVMVectorize -lLLVMInstrumentation -lLLVMX86CodeGen -lLLVMX86Desc -lLLVMX86Info -lLLVMX86AsmPrinter -lLLVMX86Utils -lLLVMSelectionDAG -lLLVMAsmPrinter -lLLVMMCParser -lLLVMJIT -lLLVMRuntimeDyld -lLLVMExecutionEngine -lLLVMCodeGen -lLLVMScalarOpts -lLLVMInstCombine -lLLVMTransformUtils -lLLVMipa -lLLVMAnalysis -lLLVMTarget -lLLVMMC -lLLVMObject -lLLVMCore -lLLVMSupport -lLLVMObjCARCOpts"
   VMKIT_LDADD="$VMKIT_BIN_DIR/../lib/libFinalMMTk.a $VMKIT_BIN_DIR/../lib/libJ3.a $VMKIT_BIN_DIR/../lib/libClasspath.a $VMKIT_BIN_DIR/../lib/libVmkit.a $VMKIT_BIN_DIR/../lib/libVmkitCompiler.a $VMKIT_BIN_DIR/../lib/libCommonThread.a"
...
if test -n "$with_vmkit";then
        ...
        LLVM_INCLUDE_DIR="$with_llvm_src"
        VMKIT_INCLUDE_DIR="$with_vmkit_src"
        AC_SUBST([LLVM_INCLUDE_DIR])
        AC_SUBST([VMKIT_INCLUDE_DIR])
	AC_DEFINE([VMKIT_ENABLED],[],[VMKIT Enabled])
fi
...
if test -n "$with_llvm_bin";then
        if (test "$with_llvm_bin" == "" || test "x$with_llvm_bin" == "xyes");then
                ...
                LLVM_LIB_DIR="$with_llvm_bin"
        fi
else
        LLVM_LIB_DIR="$with_llvm_src/Release+Asserts"
fi
...
VMKIT_CPPFLAGS="-I$LLVM_INCLUDE_DIR/include -I$LLVM_INCLUDE_DIR/ -I$VMKIT_INCLUDE_DIR/ -I$VMKIT_INCLUDE_DIR/MMTk/ -D_DEBUG -D_GNU_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS -O3 -fomit-frame-pointer -fvisibility-inlines-hidden -fPIC -Woverloaded-virtual -Wcast-qual"
AC_SUBST([VMKIT_CPPFLAGS])

VMKIT_LDFLAGS="-L$LLVM_LIB_DIR/lib -lLLVMBitReader -lLLVMipo -lLLVMVectorize -lLLVMInstrumentation -lLLVMX86CodeGen -lLLVMX86Desc -lLLVMX86Info -lLLVMX86AsmPrinter -lLLVMX86Utils -lLLVMSelectionDAG -lLLVMAsmPrinter -lLLVMMCParser -lLLVMJIT -lLLVMRuntimeDyld -lLLVMExecutionEngine -lLLVMCodeGen -lLLVMScalarOpts -lLLVMInstCombine -lLLVMTransformUtils -lLLVMipa -lLLVMAnalysis -lLLVMTarget -lLLVMMC -lLLVMObject -lLLVMCore -lLLVMSupport"
AC_SUBST([VMKIT_LDFLAGS])


VMKIT_LDADD="$VMKIT_BIN_DIR/../lib/libFinalMMTk.a $VMKIT_BIN_DIR/../lib/libJ3.a $VMKIT_BIN_DIR/../lib/libClasspath.a $VMKIT_BIN_DIR/../lib/libVmkit.a $VMKIT_BIN_DIR/../lib/libVmkitCompiler.a $VMKIT_BIN_DIR/../lib/libCommonThread.a"
AC_SUBST([VMKIT_LDADD])
