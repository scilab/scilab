...
..\..\bin\scilex.exe -ns -nwni -e roblib=lib('SCI/macros/robust/');save('SCI/macros/robust/lib',roblib);exit
echo roblib=lib('SCI/macros/robust/');save('SCI/macros/robust/lib',roblib);exit>genlib
del tmp_Macros > nul