function [tree]=sci_ones(tree)
// File generated from sci_PROTO3.g: PLEASE DO NOT EDIT !
// Copyright INRIA
// M2SCI function
// Conversion function for Matlab ones()
// Input: tree = Matlab funcall tree
// Ouput: tree = Scilab equivalent for tree
// Emulation function: mtlb_ones()
// V.C.
...
if rhs==1 then
  ...
  elseif not_a_scalar(n)
    ...
    tree.lhs(1).type=Type(Double,Real)
  // ones(n) or ones([n1,n2,...]) ?
  else 
    scitree=tree
    scitree.name="mtlb_ones"
    
    repl_poss(scitree,..
	Funcall("ones",1,Rhs(n,n,opt),tree.lhs),n,"is a scalar",..
	Funcall("ones",1,Rhs(n,opt),tree.lhs),n,"is not a scalar")
