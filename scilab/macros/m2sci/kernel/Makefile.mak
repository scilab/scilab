...
TLIST_CREATE = Contents.sci Cste.sci Equal.sci Funcall.sci Infer.sci M2scivar.sci Operation.sci Rhs.sci Type.sci Variable.sci
...
INSER = %infer_i_st.sci  %infer_i_s.sci \
	...
	%contents_i_funcall.sci %contents_i_operatio.sci %contents_i_variable.sci
#\
#	%c_i_variable.sci
...
KERNEL = allunknown.sci clause2sci.sci convert2double.sci \
	 ...
	 funcallsearch.sci variablesearch.sci \
	 ...
	 not_a_scalar.sci not_a_vector.sci not_empty.sci not_yet_converted.sci operation2sci.sci \
	 repl_poss.sci replace_brackets.sci sci_generic.sci sci_m2scideclare.sci sciparam.sci set_infos.sci translateorder.sci\
	 update_instr_list.sci updatevarslist.sci transformtree.sci mtlbtoolfun.sci
