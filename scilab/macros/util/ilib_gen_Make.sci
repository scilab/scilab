function Makename=ilib_gen_Make(name,table,files,libs,makename,with_gateway,ldflags,cflags,fflags)
//------------------------------------
// generate a Makefile for gateway
  ...
  if getenv('WIN32','NO')=='OK' then
    ...
    ilib_gen_Make_win32(name,table,files,libs,Makename,with_gateway,ldflags,cflags,fflags)
  else
     Makename = makename;
     ilib_gen_Make_unix(name,table,files,libs,Makename,with_gateway,ldflags,cflags,fflags)
  end
endfunction

function ilib_gen_Make_unix(name,table,files,libs,Makename,with_gateway,ldflags,cflags,fflags)
  fd=mopen(Makename,"w");
