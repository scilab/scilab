...
write(u,'');
write(u,'mean1 = ' + string(exp(mean(log(times(2:4,1))))));
write(u,'');
...
write(u,'');
write(u,'mean2 = ' + string(exp(mean(log(times(2:4,2))))));
write(u,'');
...
write(u,'');
write(u,'mean3 = ' + string(exp(mean(log(times(2:4,3))))));
write(u,'');
...
write(u,'');
write(u,'total = ' + string(sum(times)));
write(u,'mean4 = ' + string(exp(mean(log(times(2:4,:))))));
file('close',u);
