...
one_sec = datenum(now_date(1),now_date(2),now_date(3),now_date(7),now_date(8),30) -  datenum(now_date(1),now_date(2),now_date(3),now_date(7),now_date(8),29);
one_sec_ref = 1/(3600*24);
if  abs( (one_sec - one_sec_ref) / one_sec ) > 1e-5 then pause,end

one_min = datenum(now_date(1),now_date(2),now_date(3),now_date(7),18,now_date(9)) -  datenum(now_date(1),now_date(2),now_date(3),now_date(7),17,now_date(9));
one_min_ref = 1/(60*24);
if  abs( (one_min - one_min_ref) / one_min ) > 1e-6 then pause,end

one_hour = datenum(now_date(1),now_date(2),now_date(3),18,now_date(8),now_date(9)) -  datenum(now_date(1),now_date(2),now_date(3),17,now_date(8),now_date(9));
one_hour_ref = 1/24;
